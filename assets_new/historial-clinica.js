    ...
    function pressBtnHist(response) {
      ...
      if (response.status == 1) {
		...
		$('#keepOnSavingOption').val(response.status);
		   saveGeneralHistory();
	     saveExamenFisico(0, 0);
         saveSignoVitales(0, 0); 
	      saveExamenSistema(0);
		  //--GINECOLY----
...
function saveSospechaAbuseMaltrato(idSab) {
 ...
 $('#' + $('#id_hab_tx').val() + 'hab_t_drug').on('change', function() {
  ...
  function saveSignoVitales(signo_data, eva_cardio) {
      //--SIGNOS VITALES
	...
	function updateConDiag(id_con_diag) {	
	 ...
	 function saveExamenFisico(ex_fis_data, eva_cardio) {
		 var isGinecoloy = servicio_name_to_show.includes("GINECO");
		 if(isGinecoloy){
...
//$("#search-cie10-"+id_con_diag).keydown(function(){
...
$(document).on('click', '#saveEditOph', function(event) {
  ...
  $(document).on('click', '#saveEditSigVit', function(event) {
            ...
            saveSignoVitales($("#id_sig").val(), $("#id_eva_card").val());
...
$(document).on('click', '#resetFormObs',function(event) {
  ...
  $(document).on('change', '#exam-fisico-form', function(event) {
  	...
  	$(document).on('click', '#addBtn', function() {
             ...
             $('#tbodyControlPrenatal').append(`<tr id="R${++rowIdx}">
             <td >
                <button class="btn btn-danger remove-cont-prenatal-row btn-ms"
                  type="button"><i class="bi bi-file-x"></i></button>
                </td>
                    <td>
                        <input class="position-cont-pren" type="hidden" value="${++rowIdx}" />
                        
                            <input type="date" style="width:190px" class="form-control 0_cp_fecha" placeholder="Fecha de la consulta" >
                    ...
                    <td>
                            ...
                            <input type="text" class="form-control 0_cp_semana" placeholder="Semana" >
                           

                    </td>
                    <td>
                        
                            <input type="text" style="width:100px" class="form-control 0_cp_peso" placeholder="Peso (lb)" >
                        ...
                        <table>
                            <tr>
                                <td>
                                        ...
                                        <input type="text" style="width:100px" class="form-control 0_cp_tension_art_max" placeholder="max (mm)" >
                                ...
                                <td>
                                        ...
                                        <input type="text" style="width:100px" class="form-control 0_cp_tension_art_min" placeholder="min (hg)">
                        ...
                        <table>
                            <tr>
                                <td>
                                        ...
                                        <input type="text" style="width:100px" class="form-control 0_cp_alt_ult" placeholder="Alt. Ulterina" >
                                ...
                                <td>
                                        ...
                                        <input type="text" style="width:100px" class="form-control 0_cp_pubis_f" placeholder="Pubis.FondoCef" >
                                       
                                </td>
                                <td>-</td>
                                <td>
                                   
                                        <input type="text" style="width:100px" class="form-control 0_cp_pelv_tr" placeholder="Pelv.Tr">
                        ...
                        <table>
                            <tr>
                                <td>
                                        ...
                                        <input type="text" style="width:80px" class="form-control 0_cp_lat_min" placeholder="lat./min." >
                                        
                                </td>
                                <td>-</td>
                                <td>
                                   
                                        <input type="text" style="width:100px" class="form-control 0_cp_mov_fet" placeholder="Mov.Fetal" >
                        ...
                        <table>
                            <tr>
                                <td>
                                        ...
                                        <input type="text" style="width:100px" class="form-control 0_cp_edema" placeholder="Edema" >
                                       
                                </td>
                                <td>-</td>
                                <td>
                                    
                                        <input type="text" style="width:100px" class="form-control 0_cp_varices" placeholder="Varices" >
                    ...
                    <td>
                            ...
                            <textarea style="width:180px" class="form-control 0_cp_otro" placeholder="Otros"></textarea>
                          

                    </td>
                    <td>
                        
                            <textarea style="width:240px" class="form-control 0_cp_evolution" placeholder="Evolución"></textarea>
...
$(document).on('click', '#resetFormContPrena', function(event) {
 
      event.preventDefault();
     
      var li = "paginate-control-prenatal-li";
      var controller = "control_prenatal";
      var div = "control-prenatal-form";
      resetForm(li, controller, div);
    });


           //-------------------------------------------------------------------
$(document).on('click', '#saveEditContPrena', function(event) {
	event.preventDefault();
      saveControlPrenatal(0);
	  });
 ...
 $(".spinner-border").hide();
  ...
  $("#obs-form-radio").val(countCheckedRadio);
		 ...
		 $(document).on('change', '#contPrenatal-form', function(event) {
  ...
  function saveControlPrenatal(con_pren_data) {
      ...
      $.ajax({
        type: "POST",
        url: base_url+"saveHistorialForms/saveNewContPrena",
        data: {
          position: position,
          fecha: fecha,
          semana: semana,
	 ...
	 $('#saveEditContPrena').on('click', function(event) {
      saveControlPrenatal($("#doesContPrFomHsData").val());
	  });
