...
var timerGlie = null;
$("#"+nota_action+"glicemiae").keydown(function(){
...
/*function check_if_glicemia_normale() {
	var glicemiae= $("#"+nota_action+"glicemiae").val();
if (70 >= glicemiae || glicemiae <= 100) {
  $("."+nota_action+"glicemiae").hide();
} else{
	$("."+nota_action+"glicemiae").slideDown();
}
}*/
...
var glicemia= $("#"+nota_action+"glicemiae").val();

 if(glicemia !="" && (0  >= glicemia  || glicemia <=69 )){
	var value=glicemia + " : paciente diabetes";
$("."+nota_action+"glicemiae").css('color','red').text(value).slideDown();		
}

else if(glicemia !="" && (70  >= glicemia  || glicemia <=140 )){
	var value=glicemia + " : paciente normal";
$("."+nota_action+"glicemiae").css('color','green').text(value).slideDown();		
}
...
var timerFr = null;
$("#"+nota_action+"frex").keydown(function(){
...
//-----------------frecuencia cardiaca---------------------------------------------
var timerFc = null;
$("#"+nota_action+"fcex").keydown(function(){
...
//-----------------temporatura---------------------------------------------
var timerTp = null;
$("#"+nota_action+"tempoex").keydown(function(){
...
function tempo_r_n() {
	var tempo= $("#"+nota_action+"tempoex").val();
...
var timerTa = null;
$("#"+nota_action+"taex").keydown(function(){
...
var timerTad = null;
$("#"+nota_action+"hgex").keydown(function(){
