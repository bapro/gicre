...
function loadOnClickIndicationDrugDate(date, action, id_opertor, id_centro){
		...
		$.ajax({
		type:'POST',
		url: base_url_ind+"h_c_indication_drug/showIndicationsByDateClick",
		
		data: {date:date, table:$('.get-indication-table').val(), id_patient:$("#id_patient_hist").val(), id_opertor:id_opertor, id_centro:id_centro},
...
function loadOnClickIndicationLabDate(date, action, id_opertor, id_centro){
		...
		$.ajax({
		type:'POST',
		url: base_url_ind+"h_c_indication_lab/showIndicationsByDateClick",
		
		data: {date:date, table:'h_c_indications_labs', id_patient:$("#id_patient_hist").val(), id_opertor:id_opertor, id_centro:id_centro},
		success:function(data) {
...
function loadOnClickIndicationStudyDate(date, action, id_opertor, id_centro){
		...
		$.ajax({
		type:'POST',
		url: base_url_ind+"h_c_indication_study/showIndicationsByDateClick",
		
		data: {date:date, table:'h_c_indicaciones_estudio', id_patient:$("#id_patient_hist").val(), id_opertor:id_opertor, id_centro:id_centro},
		success:function(data) {
