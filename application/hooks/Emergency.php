...
$this->load->view('emergencia/patients_admission',$data);
...
$this->load->view('emergencia/general/emergency-general-bridge',$data);
...
$this->load->view('emergencia/general/list_of_saved_emergency',$data);
...
public function updateInsumo(){
 ...
 if($table=="hosp_peticion"){
	 $tableSave=$table;
 }else{
	$tableSave="emergency_peticion"; 
 }
...
$table_insumo=$this->uri->segment(6);
 $sql = "select id, name from  emergency_medicaments where centro=$centro && sustenacia=''";
$data['rows']= $this->db->query($sql);
$data['edit']=$this->db->select('insumo,cantidad')->where('id',$id)->get($table_insumo)->row_array();
$this->load->view('emergencia/general/nursing/editInsumo', $data);
...
$this->load->view('emergencia/general/orden-medica/content',$data);
}
...
$data['id_historial']=$this->input->post('id_historial');
$data['centro_id']=$this->input->post('centro_id');
$data['table_insumo']=$this->input->post('table_insumo');
$data['idtable']=$this->input->post('idtable');
$data['table_insumo_link']=$this->input->post('table_insumo_link');
$this->load->view('emergencia/general/nursing/insumoIndex',$data);	
}
...
INNER JOIN emergency_medicaments ON emergency_medicaments.id=$table_insumo.insumo
 WHERE  id_patient=$this->PATIENT_ID && $table_insumo.centro=$this->CENTRO_ID && saved=$saved ORDER BY $table_insumo.id DESC";
$data['querydata']= $this->hospitalization_emgergency->query($sql);
$data['totorden'] =0;
}else{
$sql = "SELECT id from $table_insumo_link WHERE user=$this->ID_USER && pat=$this->PATIENT_ID && cent=$this->CENTRO_ID ORDER BY id DESC";
...
$this->load->view('emergencia/general/nursing/data',$data);	
...
$data['query']= $this->db->query($sql);
$this->load->view('emergencia/general/procedimiento/data',$data);
}
...
public function deleteInsumo(){
	$table_insumo=$this->input->post('table_insumo');
$link=$this->hospitalization_emgergency->select('link')->where('id',$this->input->post('id'))->get($table_insumo)->row('link');	
...
$this->hospitalization_emgergency->where($where);
$this->hospitalization_emgergency->delete($table_insumo);



$query1 = $this->hospitalization_emgergency->get_where('hosp_peticion',array(
'link'=>$link
)
);
...
$this->hospitalization_emgergency->where($where);
$this->hospitalization_emgergency->delete('hosp_peticion_link');	
...
public function loadAllPatients()
{
	...
	$this->load->view('emergencia/table',$data);
}
...
$this->load->view('emergencia/create_new_emergency',$data);
}
...
$data['centro_medico'] = $this->account_demand_model->getCentroMedico();
	...
	$data['query']= $this->db->query($sql);
	$this->load->view('emergencia/update_emergency',$data);
}
...
$data['query']= $this->db->query($sql);
$this->load->view('emergencia/triage',$data);
...
$data['edad']=$age;
$this->load->view('emergencia/examFisYsigV', $data);
}
...
$this->load->view('emergencia/general/procedimiento/paginatePocedimiento', $data);
}
...
$this->load->view('emergencia/general/procedimiento/paginationDataProced',$data);
}
...
$this->load->view('emergencia/general/signo-vitales-pagination-number', $data);
}
...
$data['query_paginate']= $this->db->query($sql);
$this->load->view('emergencia/general/signo-vitales-pagination-data',$data);
}
...
$data['query_paginate']= $this->db->query($sql);
$this->load->view('emergencia/general/orden-medica/paginate',$data);
}
...
$this->load->view('emergencia/general/orden-medica/paginate/paginate-med', $data);
}
...
$data['perfil']=$this->input->post('perfil');
$data['user_id']=$this->input->post('id_user');
$this->load->view('emergencia/general/orden-medica/paginate/paginate-est', $data);
}
...
$data['perfil']=$this->input->post('perfil');
$data['user_id']=$this->input->post('id_user');
$this->load->view('emergencia/general/orden-medica/paginate/paginate-lab', $data);
}
...
$data['text']=$text;
$this->load->view('emergencia/general/orden-medica/paginate/paginate_new_ord_med', $data);
}
...
$this->load->view('emergencia/general/evaluacion-nota', $data);
...
$this->hospitalization_emgergency->insert("emergency_medicaments",$data);
...
$this->hospitalization_emgergency->insert("emergency_medicaments_orden",$orden);
}
...
$this->hospitalization_emgergency->update('emergency_medicaments', $data);
...
$this->load->view('emergencia/general/orden-medica/medicamentos/medicamentoForm',$data);
}
...
$cantidad_comp=$this->hospitalization_emgergency->select('cantidad_comp')->where('centro',$centro)->where('id',$med)->get('emergency_medicaments')->row('cantidad_comp');
echo $cantidad_comp;
}
...
function getMedAmountInStock(){
$idmed=$this->input->post('idmed');
$cantidad_comp=$this->hospitalization_emgergency->select('cantidad_comp')->where('id',$idmed)->get('emergency_medicaments')->row('cantidad_comp');
if($cantidad_comp <=0 && $cantidad_comp !=''){
	echo "<font style='color:red;font-size:11px'>agotada: $cantidad_comp</font>";
	echo '
	<script>
...
$idmed=$this->input->post('idmed');
$present=$this->hospitalization_emgergency->select('presentacion')->where('id',$idmed)->get('emergency_medicaments')->row('presentacion');
if($present){
...
$this->load->view('emergencia/general/editMedicamento', $data);
}
...
$query2 = $this->hospitalization_emgergency->query($sql2);
$cant2 =0;
...
$this->hospitalization_emgergency->update('emergency_medicaments', $data1);
...
$data['sqlop']= $this->hospitalization_emgergency->query($sqlop);


$sql ="SELECT * FROM  emergency_medicaments WHERE  DATE(inserted_time) = CURDATE() AND  id_patient=$id_patient ORDER BY id DESC";
$data['nota']= $this->hospitalization_emgergency->query($sql);
$this->load->view('emergencia/general/newMedicamento', $data);
...
//$this->load->view('emergencia/general/medicamentosData', $data);
...
$this->load->view('emergencia/general/listOfMedicamentos', $data);
...
$data['sql']= $this->db->query($sqlgb);
$this->load->view('emergencia/general/save-medicamentos', $data);
}
}
...
$data['nota']= $this->db->query($sql);
$this->load->view('emergencia/general/new-interconsullta', $data);
...
$this->load->view('emergencia/general/laboratorios/allLaboratoriosInd', $data);
}
...
$this->load->view('emergencia/general/laboratorios/NewIndicationLab', $data);
}
...
$this->load->view('emergencia/almacen_general/edit_almacen',$data);
}
...
$data['is_bodega']=0;
$this->load->view('emergencia/almacen_general/medicamento_detail_num', $data);
...
$this->load->view('emergencia/almacen_general/data', $data);
}
...
$data['query'] = $this->db->query($sql);
$this->load->view('emergencia/almacen_general/medicamentos', $data);
}
...
$this->load->view('emergencia/almacen_general/listar-bodega', $data);
...
$this->load->view('emergencia/internal-drugstore/search-patient-result', $data);
	}else{
...
$data['query'] = $this->db->query($sql);
$data['id_user']=$id_user;
$this->load->view('emergencia/factura/index',$data);
}
...
$this->load->view('emergencia/factura/search-result',$data);
...
$data['id_user']=$this->input->post('id_user');
$this->load->view('emergencia/factura/load_patient_emergency',$data);
...
$this->load->view('emergencia/factura/header-factura',$data);
$this->load->view('emergencia/factura/new-factura',$data);
}
...
$this->load->view('emergencia/factura/print_view',$data);
...
$this->load->view('emergencia/factura/factura-body-med',$data);
}
...
$this->load->view('emergencia/factura/factura-body-mat',$data);
}
...
$data['query'] = $this->db->query($sql);
$this->load->view('emergencia/factura/factura-body-est',$data);
}
...
$data['query'] = $this->db->query($sql);
$this->load->view('emergencia/factura/factura-body-lab',$data);
}
...
$data['query'] = $this->db->query($sql);
$this->load->view('emergencia/factura/factura-body-proced',$data);
}
...
$this->load->view('emergencia/factura/editEmFac',$data);	
}
...
$data['query'] = $this->db->query($sql);
$this->load->view('emergencia/factura/editEmFac2',$data);	
}
