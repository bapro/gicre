...
$user_c22=$this->db->select('name')->where('id_user',$row->user_id)->get('users')->row('name');
$user_c23=$this->db->select('name')->where('id_user',$row->user_id)->get('users')->row('name');
...
<div  class="col-md-12">
 <hr id="hr_ad"/>
 <button type='button' id='crear-proced'>Crear nuevo</button>
