...
$pat=$this->db->select('sexo,edad')->where('id_p_a',$patient_id)->get('patients_appointments')->row_array();
$data['sexo']=$pat['sexo'];
$data['edad']=$pat['edad'];
...
$data['emergency_id']=1;
$this->load->view('admin/emergencia/general/js-links');
$this->load->view('admin/emergencia/general/header',$data);
$this->load->view('admin/emergencia/general/menu-aside',$data);
$data['count_pedia']=$this->model_admin->countant_pedia($patient_id);
$data['date_nacer'] = $this->model_admin->historial_medical($patient_id);
...
$this->load->view('admin/emergencia/general/emergency-general', $data);
...
$this->load->view('admin/emergencia/general/footer', $data);
