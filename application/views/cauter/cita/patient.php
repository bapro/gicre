...
?>
<form enctype="multipart/form-data" id="sendcita" class="form-horizontal " method="post" action="<?php echo site_url('cauter/save_update_patient');?>"  > 
...
<a data-toggle="modal"   data-target="#NewC" style="float:right" href="<?php echo site_url("cauter/create_cita_again/".$id_cita->id_apoint)?>" class="btn btn-primary btn-sm" ><i class="fa fa-plus" aria-hidden="true" title="Nueva Cita"  ></i> nueva cita </a>
<i><?=$number_cita?> citas</i>

<table class="table table-striped table-bordered" style="font-size:14px">
<tr style="background:#38a7bb;color:white"><th>NEC</th><th>Causa</th><th>Area</th><th>Doctor</th><th>Fecha</th><th>Editar</th></tr>
<?php
...
<td><a style="cursor:pointer" title="Editar cita : <?=$row_rd->nec?> " data-toggle="modal"   data-target="#EditC" href="<?php echo site_url("cauter/UpdateCita/".$row_rd->id_apoint)?>" ><i class="fa fa-pencil" aria-hidden="true" ></i> </a></td>
...
$.ajax({
url: '<?php echo site_url('cauter/view_input');?>',
type: 'post',
