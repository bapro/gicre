...
<select class="form-control select2"  name="doctor" id="doctor_dropdown1"  >
...
<input type="text" class="form-control" id="fecha_propuesta1" readonly>
...
$.ajax({
type: "POST",
url: "<?php echo site_url('cauter/add_new_cita');?>",
