<?php //$bits = explode('/',$_SERVER['HTTP_REFERER']);
//echo $bits[4];
...
if(strpos($areaTitle, "ORTOPEDIA") !== false){
...
?>
  ...
  <div class="input-group mb-3">
  <span class="input-group-text" id="basic-addonps">Colocar Estado del Paciente</span>
 
<select class="form-select"  name="patient-state" id="patient-state" aria-describedby="basic-addonps">
...
<option>Seguimiento de Consulta</option>
<option>Referimientos</option>
<option>Infiltraciones/Orto biológico</option>
</select>
...
<?php } else{
echo "<h1 style='text-align:center'>No tiene acceso a esta página.</h1>";
}	?>