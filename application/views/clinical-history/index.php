...
<li class="nav-item">
<a class="nav-link collapsed" id="v-pills-urology-tab" data-bs-toggle="pill" data-bs-target="#v-pills-urology" href="#" role="tab" aria-controls="v-pills-urology" aria-selected="false">
<i class="material-symbols-outlined">rate_review </i> <span> Antecedentes Uro.</span>
</a>
</li>
  ...
  summarize
    ...
    <li>
      <a class="nav-link collapsed" id="v-pills-rehab-tab" data-bs-toggle="pill" data-bs-target="#v-pills-rehab" href="#" role="tab" aria-controls="v-pills-rehab" aria-selected="false">
...
science
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
              <li>
                 <a class="nav-link collapsed" id="v-pills-sigVital-tab" data-bs-toggle="pill" data-bs-target="#v-pills-sigVital" href="#" role="tab" aria-controls="v-pills-sigVital" aria-selected="false">
                    <i class="bi bi-circle"></i><span>Signos Vitales</span>
                </a>
            </li>
            <li>
                ...
                <a class="nav-link collapsed" id="v-pills-physicUro-tab" data-bs-toggle="pill" data-bs-target="#v-pills-physicUro" href="#" role="tab" aria-controls="v-pills-physicUro" aria-selected="false">
                    <i class="bi bi-circle"></i><span>Físico Urología</span>
                </a>
            </li>
            <li>
			    ...
			    <li>
                 <a class="nav-link collapsed" id="v-pills-pediatry-tab" data-bs-toggle="pill" data-bs-target="#v-pills-pediatry" href="#" role="tab" aria-controls="v-pills-pediatry" aria-selected="false">
                    <i class="bi bi-circle"></i><span>Pediatrico</span>
                </a>
            </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" id="v-pills-ssr-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ssr" href="#" role="tab" aria-controls="v-pills-ssr" aria-selected="false">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" id="v-pills-obs-tab" data-bs-toggle="pill" data-bs-target="#v-pills-obs" href="#" role="tab" aria-controls="v-pills-obs" aria-selected="false">
        <i class="bi bi-gender-female"></i>
    ...
    <a class="nav-link collapsed" id="v-pills-controlPrena-tab" data-bs-toggle="pill" data-bs-target="#v-pills-controlPrena" href="#" role="tab" aria-controls="v-pills-controlPrena" aria-selected="false">
	 ...
	 <li class="nav-item">
              <a class="nav-link collapsed" id="v-pills-colposcopia-tab" data-bs-toggle="pill" data-bs-target="#v-pills-colposcopia" href="#" role="tab" aria-controls="v-pills-colposcopia" aria-selected="false">
             <img src="<?= base_url();?>assets_new/img/colposcopy.jpg" width="40" >
      ...
      <ul id="indications-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="components-accordion.html1">
            ...
            <li class="nav-item">
              <a class="nav-link collapsed" id="v-pills-surgical-tab" data-bs-toggle="pill" data-bs-target="#v-pills-surgical" href="#" role="tab" aria-controls="v-pills-surgical" aria-selected="false">
                <span>  &nbsp;&nbsp;Quirúrgica</span>
              </a>
            </li><!-- End Profile Page Nav -->
			 <li class="nav-item">
              <a class="nav-link collapsed" id="v-pills-ipps-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ipps" href="#" role="tab" aria-controls="v-pills-ipps" aria-selected="false">
               <span>  &nbsp;&nbsp;IPSS</span>
              </a>
            </li><!-- End Profile Page Nav -->
			 <li class="nav-item">
              <a class="nav-link collapsed" id="v-pills-cirujanoV-tab" data-bs-toggle="pill" data-bs-target="#v-pills-cirujanoV" href="#" role="tab" aria-controls="v-pills-cirujanoV" aria-selected="false">
               <span>  &nbsp;&nbsp;Cirujano Vascular</span>
              </a>
            </li><!-- End Profile Page Nav -->
           ...
           <div class="accordion-item" style="background:none">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">1- Personales yFamiliares</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="otrosAnt-tab" data-bs-toggle="tab" data-bs-target="#otrosAnt" type="button" role="tab" aria-controls="otrosAnt" aria-selected="false"> 3- Otros Antecedentes</button>
                </li>
              </ul>
...
vape_free
   ...
   <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
       ...
       <div class="col-sm-10">
         ...
         <div class="form-floating mb-3">
           <textarea type="text" class="form-control" id="floatingSinopsis" placeholder="Sinopsis" style="height: 100px"></textarea>
 ...
 <div class="row">
  ...
  <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-colposcopia" role="tabpanel" aria-labelledby="v-pills-colposcopia-tab">
     ...
     <div class="col-md-12">
		   ...
		   <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-pediatry" role="tabpanel" aria-labelledby="v-pills-pediatry-tab">
...
<span style="display:none;color:red" id="atras18"><i>Dias de atraso : <input type="text" id="resf18" style="pointer-events:none;border:none;width:180px"></i></span>
		     ...
		     <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-cirujanoV" role="tabpanel" aria-labelledby="v-pills-cirujanoV-tab">
            <h4 class="card-title"> Cirujano Vascular</h4>
            <div class="row">
			
			 <div class="col-lg-12">
			   <div class="row">
			   <h6 class="h6" >Signos y Sintomas </h6>
			 <div class="col-md-4">
            ...
            <div class="form-check">
                   ...
                   <div class="form-check">
					 ...
					 <div class="form-floating mb-3">
              <input type="text" class="form-control" id="floatingAbdominal" placeholder="Otros" />
                <label for="floatingAbdominal">Otros</label>
              </div>
		    </div>
			 ...
			 <div class="col-lg-12">
			  ...
			  <br/>
		   <div class="row">
		   <h6 class="h6" >Antecedentes Personales</h6>
		   <div class="col-md-6">
		   	 <div class="form-floating mb-3">
              <textarea class="form-control" id="floatingAbdominal" placeholder="Historia" ></textarea>
                <label for="floatingAbdominal">Historia</label>
              </div>
		   </div>
		   <div class="col-md-6">
		   <div class="form-floating mb-3">
              <textarea class="form-control" id="floatingAbdominal" placeholder="Cirugías" ></textarea>
                <label for="floatingAbdominal">Cirugías</label>
              </div>
		   </div>
		   
		      <div class="col-md-6">
		   	 <div class="form-floating mb-3">
              <textarea class="form-control" id="floatingAbdominal" placeholder="Alergías" ></textarea>
                <label for="floatingAbdominal">Alergías</label>
              </div>
		   </div>
		   <div class="col-md-6">
		   <div class="form-floating mb-3">
              <textarea class="form-control" id="floatingAbdominal" placeholder="Enfermedades Sistémicas" ></textarea>
                <label for="floatingAbdominal">Enfermedades Sistémicas</label>
              </div>
		   </div>
		   <div class="col-md-6">
		   <div class="form-floating mb-3">
              <textarea class="form-control" id="floatingAbdominal" placeholder="Hábitos" ></textarea>
                <label for="floatingAbdominal">Hábitos</label>
              </div>
		   </div>
		    <div class="col-md-6">
		   <div class="form-floating mb-3">
              <textarea class="form-control" id="floatingAbdominal" placeholder="Examen Fisico Dirigido" ></textarea>
                <label for="floatingAbdominal">Examen Fisico Dirigido</label>
              </div>
		   </div>
		  </div>
		   </div>
