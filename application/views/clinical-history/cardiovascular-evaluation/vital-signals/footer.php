...
var timerFr = null;
$('#_'+signo_data+'_signo_v_fr').keydown(function(){
	alert(signo_data);
	  var funct;
...
if(signo_v_fr =="") 
{
$('#_'+signo_data+'_signo_fr_result').text('');
} 
else if(40 <= signo_v_fr && signo_v_fr <= 45){
$('#_'+signo_data+'_signo_fr_result').html("<i class='bi bi-check-lg text-success'  >normal</i>");
	}
 else{
$('#_'+signo_data+'_signo_fr_result').html("<i class='bi bi-exclamation-triangle text-danger'  > anormal</i>");
}
}
...
//-----------------frecuencia cardiaca---------------------------------------------
var timerFc = null;
$('#_'+signo_data+'_signo_v_fc').keydown(function(){
	  var funfc;
...
if(signo_v_fc =="") 
{
$('#_'+signo_data+'_signo_fc_result').text('');
}	
	
else if(60 <= signo_v_fc && signo_v_fc <= 80){
$('#_'+signo_data+'_signo_fc_result').html("<i class='bi bi-check-lg text-success'  >normal</i>");
}
 else{
$('#_'+signo_data+'_signo_fc_result').html("<i class='bi bi-exclamation-triangle text-danger' > anormal</i>");
}
}
...
var timerTp = null;
$('#_'+signo_data+'_signo_v_temp').keydown(function(){
...
if(signo_v_temp =="") 
{
$('#_'+signo_data+'_signo_temp_result').text('');
}	
	
else if(signo_v_temp == 37){
$('#_'+signo_data+'_signo_temp_result').html("<i class='bi bi-check-lg text-success'  >normal</i>");
}
 else{
$('#_'+signo_data+'_signo_temp_result').html("<i class='bi bi-exclamation-triangle text-danger' > anormal</i>");
...
var timerTa = null;
$('#_'+signo_data+'_signo_v_ta_mm').keydown(function(){
	  var funta;
...
if(signo_v_ta_mm =="") 
{
$('#_'+signo_data+'_tens_art_sis_result').text('');
}	
	
else if(104 <= signo_v_ta_mm && signo_v_ta_mm <= 124){
$('#_'+signo_data+'_tens_art_sis_result').html("<i class='bi bi-check-lg text-success'  >normal</i>");
}
 else{
$('#_'+signo_data+'_tens_art_sis_result').html("<i class='bi bi-exclamation-triangle text-danger' > anormal</i>");
...
var timerTad = null;
$('#_'+signo_data+'_signo_v_ta_hg').keydown(function(){
	  var funtad;
...
if(signo_v_ta_hg =="") 
{
$('#_'+signo_data+'_tens_art_dias_result').text('');
}	
	
else if(70 <= signo_v_ta_hg && signo_v_ta_hg <= 90){
$('#_'+signo_data+'_tens_art_dias_result').html("<i class='bi bi-check-lg text-success'  >normal</i>");
}
 else{
$('#_'+signo_data+'_tens_art_dias_result').html("<i class='bi bi-exclamation-triangle text-danger' > anormal</i>");
...
$('#_'+signo_data+'_signo_v_peso_lb').keyup(function () {
    var peso = $(this).val();
    var talla = $('#_'+signo_data+'_signo_v_talla').val();
    if (peso == '') {
        $('#_'+signo_data+'_signo_v_talla').prop('disabled', true);
        $('#_'+signo_data+'_signo_v_talla').val('');
        $('#_'+signo_data+'_signo_v_talla_imc').prop('disabled', true);
        $('#_'+signo_data+'_signo_v_talla_imc').val('');
    } else {
        $('#_'+signo_data+'_signo_v_talla').prop('disabled', false);
    }
    var ma = peso * 0.45;
    $('#_'+signo_data+'_signo_v_peso_kg').val(ma);
    $('#_'+signo_data+'_signo_v_peso_kg').number(true, 2);
...
$('#_'+signo_data+'_signo_v_talla').keyup(function() {
	$('#_'+signo_data+'_signo_v_talla_m').val($(this).val() * 39.37).number( true, 2);
	calculIMC();
	});
...
function calculIMC(){
	alert($('#_'+signo_data+'_signo_v_talla').val());
 var peso =$('#_'+signo_data+'_signo_v_peso_kg').val();
 var talla = $('#_'+signo_data+'_signo_v_talla').val();
var cal1 = talla * talla;
var imc_result = peso / cal1;
$('#_'+signo_data+'_signo_v_talla_imc').val(imc_result).number( true, 2 );	
}
