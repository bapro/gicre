               ...
               <tr id="R${++rowIdx}">
                 ...
                 <td>
                   <input class="position-cont-pren" type="hidden" id="id_cont_prena" value="1" />
                    <input type="date" style="width:190px" class="form-control 0_cp_fecha inputContPrenC currentDateCp" placeholder="Fecha de la consulta">
                 ...
                 <td>
                    ...
                    <input type="text" class="form-control 0_cp_semana inputContPrenC" >
                    
                   

                 </td>
                 <td>
                     <input type="text" style="width:100px" class="form-control 0_cp_peso inputContPrenC"  >
