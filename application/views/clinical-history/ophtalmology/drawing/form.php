...
[$get_centro_info_by_id, $centro_adress]= $this->get_table_data_by_id->getCentroInfo($row->id_centro);
  ...
  ?>
    <div class="col-lg-8">
				...
				<select class="form-select form-select3"  id="id_centro_refr" aria-label="Centro médico" >
				<?php 
        ...
        <tr>
          ...
          <td>
            <div class="input-group">
              ...
              <select class="select2-ofr form-control" name='od_espera' id='od_espera'>
                <option></option>
                ...
                for ($i = 0; $i <= 20; $i++) {
                  ...
                  if ($od_espera == $formatedNumber) {
                    $selected = "selected";
                  } else {
                    $selected = "";
                  }
                  echo "<option value=" . $formatedNumber . "  " . $selected . ">" . $formatedNumber . "</option>";
                }
                ?>
              </select>
            </div>
          ...
          <td>
            <div class="input-group">
              ...
              <select class="select2-ofr form-control" id="od_cilindro" name="od_cilindro">
                <option></option>
                <?php
                for ($n = 0.00; $n <= 20.00; $n += 0.25) {
                  $formatedNumber = number_format($n, 2, '.', '');
                  if ($od_cilindro == $formatedNumber) {
                    $selected = "selected";
                  } else {
                    $selected = "";
                  }
          ...
          <td>
            <select class="select2-ofr form-control" name='eje_od' id='eje_od'>
              <option></option>
              <?php

              for ($i = 0; $i <= 180; $i++) {
                $formatedNumber = number_format($i, 2, '.', '');
                if ($eje_od == $formatedNumber) {
                  $selected = "selected";
                } else {
                  $selected = "";
                }
          ...
          <td>
            <select class="select2-ofr form-control" name='add_od' id='add_od'>
              <option></option>
        ...
        <tr>
          ...
          <td>
            <div class="input-group">
              ...
              <select class="select2-ofr form-control" name='espera_os' id='espera_os'>
                <option></option>
          ...
          <td>
            <div class="input-group">
              ...
              <select class="select2-ofr form-control" name='cilindro_os' id='cilindro_os'>
                <option></option>
                <?php
                for ($n = 0.00; $n <= 20.00; $n += 0.25) {
                  $formatedNumber = number_format($n, 2, '.', '');
                  if ($cilindro_os == $formatedNumber) {
                    $selected = "selected";
                  } else {
                    $selected = "";
                  }
          ...
          <td>
            <select class="select2-ofr form-control" name='eje_os' id='eje_os'>
              <option></option>
              <?php

              for ($i = 0; $i <= 180; $i++) {
                $formatedNumber = number_format($i, 2, '.', '');
                if ($eje_os == $formatedNumber) {
                  $selected = "selected";
                } else {
                  $selected = "";
                }
          ...
          <td>
            <select class="select2-ofr form-control" name='add_os' id='add_os'>
              <option></option>
              <?php

              for ($i = 1; $i <= 3; $i++) {
                $formatedNumber = number_format($i, 2, '.', '');
                if ($add_os == $formatedNumber) {
                  $selected = "selected";
                } else {
                  $selected = "";
                }
