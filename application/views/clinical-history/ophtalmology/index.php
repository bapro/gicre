...
<main id="main" class="main">
    ...
    <div class="tab-content" id="v-pills-tabContent">
        ...
        <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-ophtalmology" role="tabpanel" aria-labelledby="v-pills-ophtalmology-tab">
       <?php   $this->load->view('clinical-history/ophtalmology/form-oph-pagination'); ?>
...
$this->load->view('clinical-history/general-report/index'); 
 ...
 $this->load->view('clinical-history/description-surgery/index'); 
  $this->load->view('clinical-history/resume/index'); 
    $this->load->view('clinical-history/ophtalmology/refraction/index'); 
