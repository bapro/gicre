...
$in_by = $this->session->userdata('user_id');
        ...
        $id_exam_sist = $row->id;
        $params2 = array('table' => 'h_c_examen_sistema', 'id' => $id_exam_sist);
    ...
    <div class="row">
        <div class="col-lg-12" id="exam-sistema-form">
            ...
            <?php if ($sis_data == 1) { ?>
                ...
                <div class="float-end">
                    ...
                    <button type="button" class="btn btn-success" id="saveEditExamSist">Guardar </button>
...
$this->session->set_userdata($datasi);
		...
		<input type="hidden" id="exam-sistema-form-inputs" value="<?= $sis_data ?>" />
    </div>
</section>
