 <div class="container">
  <div class="row">
  <div class="col-md-10">
    <a href="<?php echo base_url('admin/create_lab_lentes')?>" class="btn btn-primary btn-xs st"  title="Crear Laboratorio De Lentes"   ><i class="fa fa-plus" aria-hidden="true"></i>Crear Laboratorio De Lentes</a>
	

   <h3>Lista De Laboratorio De Lentes</h3>
 </div>
	 ...
	 ?>
        <tr>
		   <td><?=$row->nombre_comercial;?></td>
			...
			<a href="<?php echo base_url('admin/updateLabLentes/'.$row->id)?>" class="st" title="Editar" ><i class="fa fa-pencil" aria-hidden="true" title="Editar" ></i></a>
          	<a href="<?php echo base_url('admin/viewLabLentes/'.$row->id)?>" class="st"><i class="fa fa-eye" aria-hidden="true" title="Editar" ></i></a>
