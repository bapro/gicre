...
$sql_con ="SELECT id_refraccion FROM  laboratory_lentes WHERE patient=$ver->id_patient  &&  id_doc=$ver->doctor && DATE(inserted_time)='$date' ";
...
<a data-toggle="modal" data-target="#of-ref-mdl" href="<?php echo base_url("admin_medico/oftalRef/$ver->id_patient/$iduser/$ver->centro")?>"><i class="glyphicon glyphicon-sunglasses" style='font-size:18px'></i> <?=$number?> <?=$checked2?> </a>
