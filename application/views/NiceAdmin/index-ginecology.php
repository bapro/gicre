...
<i class="material-symbols-outlined">monitor_heart</i><span> Signos Vitales</span></a>
    ...
    <a class="nav-link collapsed" id="v-pills-controlPrena-tab" data-bs-toggle="pill" data-bs-target="#v-pills-controlPrena" href="#" role="tab" aria-controls="v-pills-controlPrena" aria-selected="false">
	 ...
	 <li class="nav-item">
             ...
             <img src="<?= base_url();?>assets_new/img/colposcopy.jpg" width="20" >
           ...
           <div class="accordion-item" style="background:none">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
				 ...
				 <li class="nav-item" role="presentation">
                  <button class="nav-link" id="obs-tab" data-bs-toggle="tab" data-bs-target="#obs" type="button" role="tab" aria-controls="obs" aria-selected="false"> 4- Obstétrico</button>
                </li>
				 
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="otrosAnt-tab" data-bs-toggle="tab" data-bs-target="#otrosAnt" type="button" role="tab" aria-controls="otrosAnt" aria-selected="false"> 5- Otros </button>
                </li>
              </ul>
...
<div class="tab-pane fade" id="urology" role="tabpanel" aria-labelledby="urology-tab">
       <div class="card-body">
