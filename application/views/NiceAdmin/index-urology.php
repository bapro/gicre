...
<i class="material-symbols-outlined">monitor_heart</i><span>Urología</span></a>
  </li>  
           ...
           <div class="accordion-item" style="background:none">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
				 ...
				 <li class="nav-item" role="presentation">
                  <button class="nav-link" id="urology-tab" data-bs-toggle="tab" data-bs-target="#urology" type="button" role="tab" aria-controls="urology" aria-selected="false"> 3- Urologico</button>
                </li>
                <li class="nav-item" role="presentation">
