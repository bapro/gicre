                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                             ...
                             <li><a class="dropdown-item" href="<?php echo site_url("medico/medical_assistent");?>"><i class="bi bi-gear-fill"></i> Mi Cuenta</a></li>
...
$data['controller']='medico';
 $this->load->view("patient/search/patient-seeker-form", $data); 
 ?>
