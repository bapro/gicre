...
<h3  align="center">RECIBO DE PAGO DE FACTURA</h3>
...
<td>
<?=$money_device?><?=number_format($rf->preciouni,2);?>

</td>
<td>
<?=$money_device?><?=number_format($rf->subtotal,2);?>
</td>

<td style="color:red">
<?=$money_device?><?=number_format($rf->descuento,2);?>
</td>
<td>

<?=$money_device?><?=number_format($rf->totpapat,2);?>
...
<td>
<strong><?=$money_device?><?=$sbt;?></strong>
</td>
</tr>
<?php if($comprobante){?>
...
<td>
<strong><?=$money_device?><?=$itbs?></strong>
</td>
...
<td>
<strong><?=$money_device?><?=$totgeneral?></strong>
</td>
...
<td>
<strong><?=$money_device?><?=$descu;?></strong>
</td>
...
<td>
<strong><?=$money_device?><?=number_format($total_bono,2);?></strong>
</td>
...
<td>
<strong><?=$money_device?><?=$totpagpat;?></strong>
</td>
