...
var perfil="<?=$perfil?>";
$("#contentSolInterCons").load("<?php echo base_url(); ?>/hospitalizacion/dataPaginateSolInterCons?page="+ pageNum+"&user_id="+user_id+"&id_patient="+id_patient+"&perfil="+perfil+"&user_field="+user_field);
