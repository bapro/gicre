...
<label class="control-label" ><strong style='color:red'>*</strong>Hallazgo Positivo</label>
<textarea title='obligatorio' rows="6" cols="15" class="form-control active-me" id="hallazgo"   ></textarea>
</div>
</div>
</div>
