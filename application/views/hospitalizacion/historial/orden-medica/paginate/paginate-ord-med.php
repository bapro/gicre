<?php
	 $sql = "select * from  hosp_ord_med_gen where id_sala=$idsala order by idem desc";
...
<table  class="table table-striped" cellspacing="0" >
	...
	foreach($data5->result() as $row)
	 ...
	 ?>
		...
		<a data-toggle="modal" data-target="#edit_medida_gnl" href="<?php echo base_url("hospitalizacion/edit_medida_gnl/$row->idem/$user_id")?>" style="cursor:pointer" title="Editar" class="btn-sm" ><span class="glyphicon glyphicon-pencil"></span></a>
