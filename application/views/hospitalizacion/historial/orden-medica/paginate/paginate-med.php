...
<thead>
    <tr style="background:#428bca;">
	   <th style="width:4px;color:white"><strong>Fecha</strong></th>
        ...
        <th style="width:3px;color:white">Cantidad</th>
    ...
    <?php
    $cpt="";
    $sql = "select * from  hosp_orden_medica_recetas where id_sala=$idsala order by id_i_m DESC";
  ...
  <td><?=$row->cantidad;?></td>
      ...
      <a data-toggle="modal" data-target="#edit_recetas_or_med" href="<?php echo base_url("hospitalizacion/edit_recetas_or_med/$row->id_i_m/$user_id/")?>" style="cursor:pointer" title="Editar" class="btn-sm" ><span class="glyphicon glyphicon-pencil"></span></a>
