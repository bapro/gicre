...
$i = 1;
$sql ="SELECT * FROM orden_medica_recetas WHERE idem=$id_mergencia && canceled=0 ";
...
$total_cob2=0;
$i2=1;
$sql1 ="SELECT estudio, insert_date, cantidad, descuento, cobertura, precio FROM orden_medica_estudios

WHERE idemes=$id_mergencia  AND canceled=0 ORDER BY id_i_e DESC";
...
$tot_descuento3 =0;
$i3=1;
$sql3 ="SELECT laboratory, insert_time, cantidad, descuento, cobertura, precio FROM orden_medcia_lab 
WHERE idemlab=$id_mergencia  AND canceled=0 ORDER BY id_lab DESC";
...
$i = 1;
$sql4 ="SELECT * FROM  emergency_peticion WHERE idemp=$id_em  && canceled=0 ORDER BY id DESC";
...
$tot_diff4=0;
$tot_descuento4=0;
$sql4 ="SELECT name, inserted_time, cantidad, descuento, cobertura, precio FROM emergency_procedimiento
...
<th colspan='5'></td>
<!--<th style='display:<?=$display?>' style='color:white'>Total Pagar Seguro</td>
<th style='display:<?=$display?>' style='color:white'>Total Pagar Diff</th>-->
