...
reload_reception_petition();
function reload_reception_petition(){

	$.ajax({
	url:"<?php echo base_url(); ?>internal_drugstore/reload_reception_petition",
	data: {userName: "<?=$userName?>", id_user:<?=$id_user?>,id_patient:<?=$id_patient?>},
	method:"POST",
	success:function(data){
	$('#reload_reception_petition').html(data);
