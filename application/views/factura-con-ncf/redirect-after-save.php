...
<td class="tsubtotal"><?=number_format($fac->t1, 2);?></td>
<td class="totpagpa"><?=number_format($fac->t3, 2);?></td>
<td class="totpagseg"><?=number_format($fac->t2, 2);?></td>
...
?>
<tr><th><?php echo $cnt?></th><th colspan="6">Subtotal </th><th>RD$<?=$sub_total ?></th><th>RD$<?=$total_pagar_seguro ?></th><th>RD$<?=$total_pagar_patient ?></th></tr>
