...
$.get( "<?php echo base_url();?>admin_medico/get_numero_contrado?num_cont="+num_cont, function( data ){
...
$.get( "<?php echo base_url();?>admin_medico/get_nombre_medico?medico="+medico, function( data ){
$( "#hintnumcontrato" ).html( data ); 		   
});
}
});
...
$.get( "<?php echo base_url();?>admin_medico/get_exequatur_medico?exequatur="+exequatur, function( data ){
$( "#hintnumcontrato" ).html( data ); 		   
});
}
});
...
$.get( "<?php echo base_url();?>admin_medico/get_cedula_medico?cedula="+cedula, function( data ){
$( "#hintnumcontrato" ).html( data ); 		   
});
}
});
