...
$.get( "<?php echo base_url();?>auditoria_medica/get_numero_contrado?num_cont="+num_cont, function( data ){
...
$.get( "<?php echo base_url();?>auditoria_medica/get_nombre_medico?medico="+medico, function( data ){
$( "#hintnumcontrato" ).html( data ); 		   
});
}
});
...
$.get( "<?php echo base_url();?>auditoria_medica/get_exequatur_medico?exequatur="+exequatur, function( data ){
$( "#hintnumcontrato" ).html( data ); 		   
});
}
});
...
$.get( "<?php echo base_url();?>auditoria_medica/get_cedula_medico?cedula="+cedula, function( data ){
$( "#hintnumcontrato" ).html( data ); 		   
});
}
});
