...
<img style='width:75px;height:75px'  src="<?= base_url();?>/assets/img/patients-pictures/<?php echo $row->photo; ?>"  />
</a>
...
<!--<li><a style="color:red;font-weight:bold" data-toggle="modal" data-target="#orden_medica" href="<?php echo base_url("admin_medico/reportHistorialMenu/$user_id/$id_historial/$centro_medico/6")?>" >ORDEN MEDICA</a> </li>
-->
...
<?php
 ...
 ?>
  <li><a style="color:red;font-weight:bold" data-toggle="modal" data-target="#ipss2" href="<?php echo base_url("admin_medico/reportHistorialMenu/$user_id/$id_historial/$centro_medico/4")?>" >IPSS <?=$count_ipps?> </a> </li>
...
?>
<a target="_blank" href="<?php echo site_url("$controller/historial_medical/$tut->id_tutor/$user_id/$areaid/$centro_medico/2/$user_id"); ?>"><strong><?=$tut->relacion?></strong> : <?=$tut->name_tutor?></a>
</li>
<?php
}
?>
...
<li><a style="color:#B22222;" href="javascript:void(0);" onclick="javascript:history.go(-1);">Citas</a></li>
<li><a>en modo vista</a></li>
...
<li><a> <button   class="btn btn-md btn-success"  type="submit" disabled><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar </button></a></li>
</ul>
...
<div class="modal fade" id="ipss2"  role="dialog" >
...
$('#ipss2').on('hidden.bs.modal', function () {
$(this).removeData('bs.modal');
});
