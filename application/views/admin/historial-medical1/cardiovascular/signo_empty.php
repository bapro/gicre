...
<tr>
<td colspan='2' style='border-color:#cardio-bb8fce;text-align:center;font-size:12px'>Rango (<?=$fr_tempo_rank?>)</td>
</tr>
...
<input class="form-control peso-in"  id="cardio-peso" name='cardio_peso' type="text">
   <span class="input-group-addon">lb</span>
   <input class="form-control kg-in"  id="cardio-kg" name='cardio_kg' type="text">
...
<input class="form-control" id="cardio-ta" name='cardio_ta' type="text"> 
</div>
</div>
...
<input class="form-control " id="cardio-hg" name='cardio_hg' type="text">
</div>
</div>
...
<input type="radio" id="cardio-radio_signo" name="cardio_radio_signo" value="SANO" checked /> sano	 		
</td>
</tr>
...
<div class="input-group">
<input class="form-control talla-in" title="talla en metro" name='cardio_talla' id="cardio-talla-ef" type="text">
...
<input class="form-control" id="cardio-fr" placeholder="Fr" name='cardio_fr'  type="text">
...
<input class="form-control " id="cardio-tempo" name='cardio_tempo' placeholder="Tempo" type="text">
...
<td style="width:1px" >
<input type="radio" id="cardio-radio_signo" name="cardio_radio_signo" value="AGUDAMENTE ENFERMA"/> agudamente enferma 	 		
</td>
</tr>
...
<div class="col-sm-9">
	<div class="input-group">
		<input class="form-control formatnum imc-in" id="cardio-imc" name='cardio_imc'  type="text" readonly>
...
<input class="form-control" id="cardio-fc" name='cardio_fc'  placeholder="Fc" type="text">
...
<div class="col-sm-5 col-sm-offset-1">
<div class="input-group">
<input class="form-control " id="cardio-pulso" name='cardio_pulso' placeholder="Pulso" type="text">
...
<td style="width:1px" >
<input type="radio" id="cardio-radio_signo" name="cardio_radio_signo"  value="CRONICAMENTE ENFERMA"/> cronicamento enferma		 		
</td>
</tr>
...
<div class="col-md-6">
<input class="form-control" id="cardio-glicemia" name='cardio_glicemia' type="text">
...
//------------------------------------------------------------------------------------
$("#cardio-peso").keyup(function() {
  var peso = $(this).val();
  var talla =$("#cardio-talla-ef").val();
if(peso==""){
$("#cardio-talla-ef").prop("disabled", true);
$("#cardio-talla-ef").val("");
$("#cardio-imc").prop("disabled", true);
$("#cardio-imc").val("");
}
else{
$("#cardio-talla-ef").prop("disabled", false);
};
var ma = peso * 0.45;
$("#cardio-kg").val(ma);
$("#cardio-kg").number( true, 2 );;
$("#cardio-kgtext").text(ma);
$('#cardio-kgtext').number( true, 2 );
$('#cardio-kgsimb').text('kg').css('font-style','italic');
});

//------------------------

$("#cardio-talla-ef").keyup(function() {
  var talla = $(this).val();
  var peso =$("#cardio-kg").val();

//calcul imc
//$('.number').number( myNumber, 2 )
var cal1 = talla * talla;
var imc_result = peso / cal1;
$("#cardio-imc").val(imc_result);
});

$('#cardio-imc').number( true, 2 );




var timerGli = null;
$('#cardio-glicemia').keydown(function(){
...
var glicemia= $('#cardio-glicemia').val();
