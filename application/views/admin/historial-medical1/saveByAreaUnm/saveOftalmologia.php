...
var canvasFo = canvas21.toDataURL("image/png");
 ...
 $.ajax({
type: "POST",
url: "<?=base_url('saveHistorialUnm/saveOftalmologia')?>",
...
retine1:retine1,retine2:retine2,retine3:retine3,retine4:retine4,retine5:retine5,retine6:retine6,retine7:retine7,retine8:retine8,
...
conj1:conj1,conj2:conj2,cornea1:cornea1,cornea2:cornea2,pup1:pup1,pup2:pup2,crist1:crist1,crist2:crist2,
vitreo1:vitreo1,vitreo2:vitreo2,not_oftm:not_oftm,fondos1:fondos1,fondos2:fondos2,canvasOj:canvasOj,canvasFo:canvasFo,
hist_id:hist_id,inserted_by:inserted_by,user_id:user_id,centro_medico:centro_medico,plan:plan,cied:cied,otros_diagnos:otros_diagnos},
dataType: 'json',
cache: true,
