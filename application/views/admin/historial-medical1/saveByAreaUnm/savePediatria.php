...
var  no_ap18 = $("#no_ap1818").val();
 ...
 $.ajax({
type: "POST",
url: "<?=base_url('saveHistorialUnm/savePediatria')?>",
...
evo:evo,evol_text:evol_text,/*dosis:dosis,tiempo:tiempo,edad:edad,via:via,*/tnaci:tnaci,describa:describa,edad_gest:edad_gest,pesopd:pesopd,talla:talla,descoa:descoa,descob:descob,lactamat1:lactamat1,leche1:leche1,otrosinfo:otrosinfo,traum_text:traum_text,trans_text:trans_text,
