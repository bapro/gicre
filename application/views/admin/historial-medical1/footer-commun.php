...
<p>¿ Quiere enviar la historia clínica al paciente por correo electrónico ?</p>
<button class="btn no-email">No</button>  
<button class="btn  btn-md btn-success si-email" >Si</button>
</br/></br/>
<div class="email-patient" style="display:none"> 

<div class="form-group">
<div class="row">
<div class="col-md-12">
<input   placeholder="Ingrese el correo electronico" class="form-control correo-input" type="email" >
</br/>
<button class="btn btn-md btn-success" id="enviar-email" >Enviar</button>
</div>
</div>
</div>
</div>
