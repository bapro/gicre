...
<strong>Cambiado por</strong> <?=$user_c29?>, <?=$updated_time?>
 "
rel="tooltip" data-trigger="hover"  data-placement="bottom" data-html="true" data-toggle="modal" data-target="#ver_exasis" href="<?php echo base_url("admin_medico/show_examsis_by_id/$row->id_exs/$user_id/$centro")?>">
...
<select class="form-control select2" id="sisneuro" style="width:100%" data-select2-tags="true">
...
<select class="form-control select2" style="width:100%" id="siscardio" data-select2-tags="true">
<option value="">Ningúno</option>
<?php 
...
<select class="form-control select2" id="sist_uro" style="width: 100%" data-select2-tags="true">
<option value="">Ningúno</option>
<?php 
...
<select class="form-control select2" id="sis_mu_e" style="width: 100%" data-select2-tags="true">
...
<select class="form-control select2" id="sist_resp" style="width:100%" data-select2-tags="true">
<option value="">Ningúno</option>
<?php 
...
<select class="form-control select2" id="sist_diges" style="width:100%" data-select2-tags="true">
<option value="">Ningúno</option>
<?php 
...
<select class="form-control select2" id="sist_endo" style="width:100%" data-select2-tags="true">
<option value="">Ningúno</option>
<?php 
...
<select class="form-control select2" id="sist_rela" style="width:100%" data-select2-tags="true">
...
$.ajax({
url:"<?php echo base_url(); ?>admin_medico/examSistSisMuEs",
data: {},
method:"POST",
...
function examSistRelativoA(){
$.ajax({
url:"<?php echo base_url(); ?>admin_medico/examSistRelativoA",
data: {},
method:"POST",
success:function(data){
$('#sist_rela').html(data);
