...
<span class="input-group-addon"><span  ><b><?=$count_ssr?></b> </span>regitros (s)</span> 
<div id="load-re-ssr">
...
<br/>
<div class="col-md-12 backg" style="border-top:1px solid rgb(205,205,205)">
<div class="col-md-6" style="border-right:1px solid rgb(205,205,205);">
<br/><input type="hidden" id="operation" value="insert" > 
...
<label class="col-md-6 control-label">Fecha de ultima PAP</label>
