...
<input type="text" id="sala"  class="form-control" disabled /> <p id='processing-sala'></p>
</div>
...
$('#centro').change(function(e){
 ...
 $.ajax({
url:'<?php echo base_url();?>admin_medico/saveOrdMedSala',
...
$(".btn-dis-or-med").prop("disabled",false);
	...
	$.ajax({
url:"<?php echo base_url(); ?>admin_medico/editSala",
