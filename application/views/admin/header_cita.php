...
<li class="dropdown" style="font-size:13px" >
  ...
  <li><a data-toggle="modal" data-target="#messageViewed" href="<?php echo base_url('admin_medico/chatBox/'.$id_usr)?>" ><i class='fa fa-comments' style='font-size:20px'></i> Chatear</a></li>
...
<script>
 ...
 setInterval(function(){
  $('#new_message').load("<?php echo base_url('admin_medico/newMessageReceived/'.$id_usr)?>").fadeIn("slow");
 }, 1000);
</script>