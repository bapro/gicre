...
<div class="container"  >
 ...
 <div class="col-md-7">
 <h2>LABORATORIO FARMACEUTICO</h2>
...
echo "<span style='color:black'>Creado por : $user_c18 ($inserted_time) <br/> Modificado por $user_c19 ($updated_time)</span>";?>
 ...
 <div class="dropdown">
  ...
  <li><a  href="<?php echo base_url('admin/updateEstudios/'.$row->id)?>">Editar</a></li>
 <!-- <li><a href="#">Inhabilitar Centro Medico</a></li>-->
  <li><a href="<?php echo base_url('admin/newEstudios')?>">Crear Nuevo</a></li>
  </ul>
</div>
 </div>
...
<tr>
<th class="thh">REGISTRO SAN.</th>
<td class="vtd"><?=$row->registro_sanitario;?></td>
