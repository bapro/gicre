<div class="container">
 ...
 <h3 class="h3">Crear Estudios</h3>
 <br/>
 </div>
 
<?php echo $this->session->flashdata('success_msg'); ?>
<form   class="form-horizontal" id="form-save" enctype="multipart/form-data" method="post"  action="<?php echo site_url('admin/saveEstudios');?>" > 
...
<input type="text" class="form-control" id="web"  name="web"   >
 ...
 <input type="submit"  class="btn btn-primary btn-xs col-md-offset-4" value="Enviar" id="save" >
<br/><br/>
 </form>
</div>
 </div>
