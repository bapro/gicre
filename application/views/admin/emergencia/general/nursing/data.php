...
$sqlrs = "SELECT *,$table_insumo.id AS id_insumo from $table_insumo 
...
<a  title="Editar" data-toggle="modal" data-target="#editInsumo1" href="<?php echo base_url("emergency/editInsumo/$rowrs->id_insumo/$user_id/$rowrs->centro/$table_insumo")?>"  ><i class="fa fa-pencil" aria-hidden="true"></i></a>
<a title="Eliminar" style="cursor:pointer" class="delete-insumo" id="<?=$rowrs->id_insumo; ?>" ><i class="fa fa-trash" style="color:red"></i></a>
<?php } else {echo "<i style='color:red' class='fa fa-ban'></i>";}?>
</td>
</tr>
<?php } ?>
...
data: {id : del_id,table_insumo:"<?=$table_insumo?>"},
