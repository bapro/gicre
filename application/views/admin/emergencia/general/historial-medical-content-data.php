...
<a target="_blank" href="<?php echo base_url("printings/print_ant_gnrl/$historial_id/$areaid/$user_id")?>" style="cursor:pointer" title="Imprimir Antecedentes General" class="btn-sm" ><i style="font-size:24px" class="fa">&#xf02f;</i></a>
</th>
</tr>
...
<option value="" hidden><?=$row->grouposang?></option>
<option>A</option>
<option>B</option>
<option>AB</option>
<option>0</option>
