...
?>
<h3 class="modal-title text-left"  >Ant. S.S.R # <span class="round"><?=$row->idssr?></span> </h3><br/>
<h5 class="modal-title text-left"  >Creado por :<?=$row->inserted_by?> | fecha :<?=$inserted_time?> | <span style="color:red"> Cambiado por :<?=$row->inserted_by?> | fecha :<?=$update_time?></span> </h5>
<br/>

<button  class="show_modif_ant_ssr btn-sm btn-success "><i class="fa fa-pencil" aria-hidden="true"></i> Editar</button>
<button id="save_ant_ssr_hide" class="save_ant_ssr_hide btn-lg btn-success" style="display:none"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
<hr class="hr_ad"/>
