...
Creado por :<?=$row->inserted_by?> | fecha :<?=$inserted_time?> 
</h5>
<div class="col-md-12 text-center"> <a target="_blank"  href="<?php echo base_url('printings/print_cont_p/'.$row->id_c1)?>" style="cursor:pointer" title="Imprimir Antecedentes General" class="btn-sm" ><i style="font-size:24px" class="fa">&#xf02f;</i></a></div>
...
<td><label>#</label></td>
<td><label>Fecha de la consulta</label></td>
<td><label>Semana de amenorrea</label></td>
<td><label>Peso (lb)</label></td>
<td><label>Tension Arterial Max.Min.- (mm Hg)</label></td>
<td><label>[Alt. Ulterina] - [Present Pubis.FondoCef] - [Pelv.Tr]</label></td>
<td><label>F.C.F.(lat.-min.-Mov.Fetal)</label></td>
<td><label>Edema - Varices</label></td>
...
<input class="editInput  form-control input-sm fecha-cpp" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<button type="button" class="btn btn-sm btn-default editBtn" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
...
<input class="editInput2 form-control input-sm fecha-cpp2" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn2" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<input class="editInput3 form-control input-sm fecha-cpp3" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn3" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<input class="editInput4 form-control input-sm fecha-cpp4" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn4" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<input class="editInput5 form-control input-sm fecha-cpp5" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn5" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<input class="editInput6 form-control input-sm fecha-cpp6" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn6" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<input class="editInput7 form-control input-sm fecha-cpp7" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn7" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<input class="editInput8 form-control input-sm fecha-cpp8" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn8" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
...
<td>9</td>
<td>
<span class="editSpan9 fechacpp9"><?=$row->fecha?></span>
<input class="editInput9 form-control input-sm fecha-cpp9" type="text"  value="<?=$row->fecha?>" style="display: none;color:black">
</td>

<td>
<span class="semanacpp9 editSpan9"><?=$row->semana?></span>
<input class="editInput9 form-control input-sm semana-cpp9" type="text"  value="<?=$row->semana?>" style="display: none;color:black">
</td>


<td>
<span class="pesocpp9 editSpan9"><?=$row->peso?></span>
<input class="editInput9  form-control input-sm peso-cpp9" type="text"  value="<?=$row->peso?>" style="display: none;color:black">
</td>


<td>
<span class="editSpan9"><span class="tension1cpp9"><?=$row->tension?></span>-<span class="tension11cpp9"><?=$row->tension11?></span></span>
<div class="input-group sepa tensionshow9 editInput9" style="display: none;" >
<input class="editInput  form-control input-sm reduce-height tension1-cpp9"    type="text" value="<?=$row->tension?>" style="color:black" /> 
<span class="input-group-addon reduce-height" >-</span>
 <input class="editInput  form-control input-sm reduce-height tension11-cpp9"  type="text"   value="<?=$row->tension11?>"  style="color:black"/>
 </div>
</td>
...
<td>
<span class="editSpan9"><span class="alt1cpp9"><?=$row->alt?></span>-<span class="alt11cpp9"><?=$row->alt11?></span>-<span class="alt111cpp9"><?=$row->alt111?></span></span>
<div class="input-group sepa alt1-show9 editInput9" style="display: none;" >
<input class="editInput  form-control input-sm reduce-height alt1-cpp9"    type="text" value="<?=$row->alt?>" style="color:black" /> 
<span class="input-group-addon reduce-height" >-</span>
 <input class="editInput  form-control input-sm reduce-height alt11-cpp9"  type="text"   value="<?=$row->alt11?>"  style="color:black"/>
 <span class="input-group-addon reduce-height" >-</span>
  <input class="editInput  form-control input-sm reduce-height alt111-cpp9"  type="text"   value="<?=$row->alt111?>"  style="color:black"/>
 </div>
</td>
...
<td>
<span class="editSpan9"><span class="fetal1cpp9"><?=$row->tension?></span>-<span class="fetal11cpp9"><?=$row->tension11?></span></span>
<div class="input-group sepa fetal1-show9 editInput9" style="display: none;" >
<input class="editInput  form-control input-sm reduce-height fetal1-cpp9"    type="text" value="<?=$row->fetal?>" style="color:black" /> 
<span class="input-group-addon reduce-height" >-</span>
 <input class="editInput  form-control input-sm reduce-height fetal11-cpp9"  type="text"   value="<?=$row->fetal11?>"  style="color:black"/>
 </div>
</td>
...
<td>
<span class="editSpan9"><span class="edema1cpp9"><?=$row->edema?></span>-<span class="edema11cpp9"><?=$row->edema11?></span></span>
<div class="input-group sepa edema1-show9 editInput9" style="display: none;" >
<input class="form-control input-sm reduce-height edema1-cpp9"    type="text" value="<?=$row->edema?>" style="color:black" /> 
<span class="input-group-addon reduce-height" >-</span>
 <input class="form-control input-sm reduce-height edema11-cpp9"  type="text"   value="<?=$row->edema11?>"  style="color:black"/>
 </div>
</td>
...
<td>
<span class="editSpan9"><span class="otroscpp9"><?=$row->otros?></span></span>
<textarea  style="display:none;width:190px"  class="form-control otros-cpp9 editInput9" cols="20"><?=$row->otros ?></textarea>
</td>


<td>
<span class="editSpan9"><span class="evolucioncpp9"><?=$row->evolucion?></span></span>
<textarea  style="display:none;width:190px"  class="form-control evolucion-cpp9 editInput9" cols="20"><?=$row->evolucion ?></textarea>
</td>
...
<td>
<div class="btn-group btn-group-sm"> 
<button type="button" class="btn btn-sm btn-default editBtn9" style="float: none;" title="Cambiado por :<?=$row->updated_by?> | fecha :<?=$updated_time?>"><span class="glyphicon glyphicon-pencil"></span></button>
<!--<button type="button" class="btn btn-sm btn-default deleteBtn" style="float: none;"><span class="glyphicon glyphicon-trash"></span></button>-->
</div>
