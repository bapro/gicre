...
$(".show_modif_ant_ped").on('click', function (e) {
	$('.show_modif_ant_ped').hide();
	$(".save_ant_ped_hide").slideDown();
...
evo:evo,evol_text:evol_text,med:med,tnaci:tnaci,describa:describa,edad_gest:edad_gest,peso:peso,talla:talla,desco_talla_al_nacer:desco_talla_al_nacer1,desco_peso_al_nacer:desco_peso_al_nacer1,lactamat1:lactamat11,leche1:leche11,otrosinfo:otrosinfo,traum_text:traum_text,trans_text:trans_text,
...
alert('An erroroccurred... Look at the console (F12 or Ctrl+Shift+I, Console tab) for more information!');
                ...
                $('#loadf').html('<p>statuscode: '+jqXHR.status+'</p><p>errorThrown: ' + errorThrown + '</p><p>jqXHR.responseText:</p><div>'+jqXHR.responseText + '</div>');
                console.log('jqXHR:');
                console.log(jqXHR);
