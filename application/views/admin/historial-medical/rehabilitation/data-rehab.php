...
<h3 class="modal-title text-center"  >Rehabilitacion # <span class="round"><?=$row->id_rehab?></span> </h3><br/>
<h5 class="modal-title text-center"  >Creado por :<?=$row->inserted_by?> | fecha :<?=$inserted_time?> | <span style="color:red"> Cambiado por :<?=$row->updated_by?> | fecha :<?=$inserted_time?></span> </h5>
 <br/>
...
<button type="button" id="save_rehab_hide" class="save_rehab_hide btn-sm btn-success" style="display:none"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
 <a target="_blank" href="<?php echo base_url("printings/print_rehab/$row->id_rehab")?>" style="cursor:pointer" title="Imprimir Antecedentes General" class="btn-sm" ><i style="font-size:24px" class="fa">&#xf02f;</i></a>
...
<select  class="form-control" disabled   id="marcha_inicio1" >
...
<select  class="form-control" disabled   id="long_mov_der1" >
...
<option>No sobrepasa el pie izquierdo con el paso</option>
 ...
 <label class="control-label">b) Movimiento del pie izquierdo</label>
   ...
   <select  class="form-control" disabled   id="long_mov_izq1" >
...
<select  class="form-control" disabled  id="long_simetria1" >
...
<select  class="form-control" disabled   id="long_fluidez1" >
...
<select  class="form-control" disabled   id="long_traject1" >
...
<select  class="form-control" disabled  id="long_tronco1" >
...
<select  class="form-control" disabled  id="long_postura1" >
...
<select  class="form-control" disabled  id="equi_sentado1" >
...
<select  class="form-control" disabled  id="equi_levantarse1" >
...
<select  class="form-control" disabled   id="equi_intentos1" >
...
<select  class="form-control" disabled  id="equi_biped11" >
...
<select  class="form-control" disabled  id="equi_biped21" >
...
<select  class="form-control" disabled  id="equi_emp1" >
...
<select  class="form-control" disabled  id="equi_ojos1" >
...
<select  class="form-control" disabled   id="equi_vuelta1" >
...
<select  class="form-control" disabled   id="equi_sentarse1" >
...
<select  class="form-control" disabled  id="eval_balsys1" >
...
<select  class="form-control" disabled   id="eval_movim1" >
...
<select  class="form-control" disabled   id="eval_monop1" >
...
<select  class="form-control" disabled   id="criteria_intens1" >
...
<select  class="form-control" disabled  id="criteria_cuidado11" >
...
<select  class="form-control" disabled  id="levantar_peso1" >
...
<select  class="form-control" disabled   id="criteria_caminar1" >
...
<select  class="form-control" disabled   id="criteria_estar_sent1" >
...
<select  class="form-control" disabled  id="criteria_dormir1" >
...
<select  class="form-control" disabled   id="criteria_sexual1" >
...
<select  class="form-control" disabled   id="criteria_vida1" >
