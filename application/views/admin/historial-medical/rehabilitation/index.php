...
<div id="show-rehab"></div>
<div id="hide-rehab" style="margin-left:210px">
<div  style="overflow-x:auto;">

<h4 class=" h4 his_med_title" >rehabilitacion</h4>
<br/>
<div class="col-xs-12"  >
<div class="col-xs-5" >
<div class="input-group" >
 <span  class="input-group-addon"><span style="color:green;font-size:20px"><b><?=$count_rehab?></b></span> registro (s)</span> 
 <select class="form-control" id="id_rehab" >
<option hidden>Navegador</option>
<?php 

 foreach($rehab as $rows)
{
?>
<option value="<?=$rows->id_rehab;?>">Registro # (<?=$rows->id_rehab;?>) </option>
...
<span class="success-send-rehab input-group-addon"  style="display:none" id="resetrehab">
 
 <div class="btn-group">
<button type="button" style="background:green;color:white" id="show_af_c_r"><i  class="glyphicon glyphicon-plus" aria-hidden="true"></i> Nuevo</button>
...
<br/></br>
<hr  style="border-bottom: 2px groove #38a7bb;"/>
...
<select  class="form-control"   id="marcha_inicio" >
...
<select  class="form-control"   id="long_mov_der" >
<option value="" hidden>Seleccionar</option>
<option>No sobrepasa el pie izquierdo con el paso</option>
  ...
  <select  class="form-control"   id="long_mov_izq" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="long_simetria" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="long_fluidez" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="long_traject" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="long_tronco" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="long_postura" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="equi_sentado" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="equi_levantarse" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="equi_intentos" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="equi_biped1" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="equi_biped2" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="equi_emp" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="equi_ojos" >
<option value="" hidden>Seleccionar</option>
<option>Inestable</option>
<option>Estable</option>
</select>
...
<select  class="form-control"   id="equi_vuelta" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="equi_sentarse" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="eval_balsys" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="eval_movim" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="eval_monop" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="criteria_intens" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="criteria_cuidado1" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="levantar_peso" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="criteria_caminar" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="criteria_estar_sent" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"  id="criteria_dormir" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="criteria_sexual" >
<option value="" hidden>Seleccionar</option>
...
<select  class="form-control"   id="criteria_vida" >
<option value="" hidden>Seleccionar</option>
...
$("#id_rehab").on('change', function (e) {
e.preventDefault();
$("#loadf").fadeIn().html('<span class="glyphicon glyphicon-refresh glyphicon-refresh-animate load"></span>');

$.ajax({
url: '<?php echo site_url('admin/showRehabById');?>',
type: 'post',
data:'on_select_show='+$("#id_rehab").val(),
success: function (data) {
	$("#save_rehabilidad").hide();
	$("#flash-reab").hide();
	$("#loadf").hide();
	$("#show_rehab_after_select").html(data);
	$("#show_rehab_after_select").show();
	$("#hide_rehab_after_select").hide();
	$("#resetrehab").show();
	 }
});
});
...
//-----------------------------------------
	 ...
	 //refresh
$("#show_af_c_r").on('click', function (e) {
e.preventDefault();
$("#loadf").fadeIn().html('<span class="glyphicon glyphicon-refresh glyphicon-refresh-animate load"></span>');
