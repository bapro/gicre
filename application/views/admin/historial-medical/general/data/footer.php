...
$(".deac2 :input").prop("disabled", false);

})

//--------------otros ante---------------------

$('#edit_datao').on('click', function() {
//$("#edit_datao").fadeOut(1000).html('<span class="load"> <img  src="<?= base_url();?>assets/img/loading.gif" /></span>');
$("#edit_datao").hide();
$("#save_edit_datao").slideDown();
$("#save_edit_datao").prop("disabled", false);
$(".deac3 :input").prop("disabled", false);
})
...
$(".deac4 :input").prop("disabled", false);
})
//--------------Habitos toxicos---------------------
...
$(".habitos-t :input").prop("disabled", false);
})
...
var hab_f_drug = $("#hab_f_drug").val();
 ...
 $.ajax({
type: "POST",
url: "<?=base_url('admin/updateHabitosT')?>",
data: {hab_c_caf:hab_c_caf,hab_f_caf:hab_f_caf,hab_c_pip:hab_c_pip,hab_f_pip:hab_f_pip,hab_c_ciga:hab_c_ciga,hab_f_ciga:hab_f_ciga,hab_c_al:hab_c_al,hab_f_al:hab_f_al,hab_c_tab:hab_c_tab,hab_f_tab:hab_f_tab,hab_t_drug:hab_t_drug,hab_c_drug:hab_c_drug,hab_f_drug:hab_f_drug,hist_id:hist_id,modify_by:modify_by},
cache: true,

success:function(data){
$('.msgs').html('Datos editados con éxito.').fadeIn('slow').delay(5000).fadeOut('slow');
...
var hist_id = $("#hist_id").val();
 ...
 $.ajax({
type: "POST",
url: "<?=base_url('admin/updateAntAl')?>",
...
$("#save_edit_datad").hide();
$("#edit_datad").show();
$(".deac2 :input").prop("disabled", true);
}  
});
return false;
...
//=====================Otros ante===========================
$('#save_edit_datao').on('click', function(event) {
event.preventDefault();
var modify_by = $("#modify_by").val();
var hist_id = $("#hist_id").val();
//-----otros ant-----------------
...
var selectmedic = $("#selectmedic").val();
 ...
 $.ajax({
type: "POST",
url: "<?=base_url('admin/updateAnteOtros')?>",
data: {quirurgicos:quirurgicos,gineco:gineco,abdominal:abdominal,toracica:toracica,transfusion:transfusion,otros1:otros1,hist_id:hist_id,modify_by:modify_by},
cache: true,
success:function(data){
$('.msgs').html('Datos editados con éxito.').fadeIn('slow').delay(5000).fadeOut('slow');
$("#save_edit_datao").hide();
$("#edit_datao").show();
$(".deac3 :input").prop("disabled", true);
}  
});
return false;
})
...
var violencia4 = $("#violencia4").val();
 ...
 $.ajax({
type: "POST",
url: "<?=base_url('admin/updateViolencia')?>",
...
$("#save_edit_datav").hide();
$("#edit_datav").show();
$(".deac4 :input").prop("disabled", true);
}  
});
return false;
})
...
var otros = $("#otros").val();
 $.ajax({
type: "POST",
url: "<?=base_url('admin/updateMarquePos')?>",
...
success:function(data){
//	alert(data);
$('.msgs').html('Datos editados con éxito.').fadeIn('slow').delay(3000).fadeOut('slow');
