...
<button class="btn-sm btn-success historial_save" style="font-weight:bold" type="submit" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
...
<div class="col-xs-5" style="display:none" id="reset2">
...
<div class="col-sm-7">
	<div class="input-group">
		<input class="form-control" id="imc"  type="text" readonly>
...
e.preventDefault();
$("#flash1").fadeIn(400).html('<span class="load">Mostrando... <img src="<?= base_url();?>assets/img/loading.gif" /></span>');
