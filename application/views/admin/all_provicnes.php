...
<table id="example" class="table table-striped table-bordered" style="margin:auto" width="70%" cellspacing="0">
    ...
    <tbody>
    <?php foreach($all_provinces as $all_a)
	 ...
	 ?>
		...
		<td class="seguro_medico" style="width:5px"><?=$all_a->title;?></td>
            <td style="width:1px" >
			<a href="<?php echo base_url('admin/Province/'.$all_a->id)?>" class="st" title="Ver" ><i class="fa fa-eye" aria-hidden="true" ></i></a>
