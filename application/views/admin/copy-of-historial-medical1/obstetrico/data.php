...
<label style="<?=$color?>">Otros </label></td>
<td>
<?php
if($row->otros1 =="no"){
	$checked="checked";
...
<tr>
<td>
<?php if($row->fiebre ==0){$color="";} else{$color="color:red";}?>
<label style="<?=$color?>"> Fiebre </label></td>
<td>
 <?php
if ($row->fiebre ==0){
	$selected="";
...
<tr>
<td>
<?php if($row->artra ==0){$color="";} else{$color="color:red";}?>
...
<tr>
<td>
<?php if($row->mia ==0){$color="";} else{$color="color:red";}?>

<label style="<?=$color?>">Mialgia </label> </td>
<td>
 <?php
if ($row->mia ==0){
	$selected="";
...
<tr>
<td>
<?php if($row->exa ==0){$color="";} else{$color="color:red";}?>
<label style="<?=$color?>">Exantema cutaneo </label></td>
<td>
 <?php
if ($row->exa ==0){
	$selected="";
...
<tr>
<td> 
<?php if($row->con ==0){$color="";} else{$color="color:red";}?>
<label style="<?=$color?>">Conjuctivitis no purulenta/hiperemica </label> </td>
<td>
 <?php
if ($row->con ==0){
	$selected="";
