<?php
	...
	$data['centro_medico']=$centro_medico;
	 ...
	 $data['hist']=$hist;
	 $data['trueuser']=decrypt_url($this->uri->segment(8));
...
$where_gnr="AND id_user=$user_id";
$where_fib="AND user=$user_id";
$where_q="AND id_user=$user_id";
}
...
$this->load->view('admin/historial-medical1/header-mode-view',$data);
if($areaid==0){
if($user_id==344){
