...
<p><strong> <img style="width:120px" src="<?= base_url();?>assets/img/gicle1.png" alt="Admedicall">BUSCAR ESTUDIOS</strong></p>
<hr id="hr_ad"/>
<div class="col-md-6">
...
window.location ="<?php echo base_url(); ?>printings/search_code_estudios?code="+code; 	
