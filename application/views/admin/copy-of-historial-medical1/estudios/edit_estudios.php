<?php
 foreach($edit_estudios as $row_edit)
...
<div class="col-md-12 text-center"> <a target="_blank"  href="<?php echo base_url("printings/print_estudios/$historial_id/$row_edit->id_i_e/$area/$row_edit->operator")?>" style="cursor:pointer" title="Imprimir Antecedentes General" class="btn-sm" ><i style="font-size:24px" class="fa">&#xf02f;</i></a></div>
...
<input type="number" value="<?=$row_edit->lateralidad?>" class="form-control" id="lateralidad2" min="1" />
...
$.ajax({
type: "POST",
url: "<?=base_url('admin_medico/UpdateFormIndEst')?>",
