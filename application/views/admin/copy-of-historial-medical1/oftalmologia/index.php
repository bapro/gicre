...
<div class="col-md-12" style="background:">
<hr class="title-highline-top"/>
<div class="col-md-7" style="border-right:1px solid rgb(205,205,205);border-bottom:1px solid rgb(205,205,205);">
...
<textarea rows="8"  id="not-oftm" class="form-control"></textarea></td>

</tr>
</table>

</div>
<div class="col-md-5" id="div-ojo">
...
<div class="col-md-5" id='frame-fondo1' style="border-top:1px solid rgb(205,205,205);" >
...
var btnSpeechOftal1 = document.getElementById('btnSpeechOftal1');

btnSpeechOftal1.onclick = function() {
var output = document.getElementById("not-oftm");
