...
<div class="row">
  ...
  <label>DP</label> <input type="text" name='d-prf2' value="<?=$row->d_prf?>" style='width:30%'> <label>Mm</label> 
  <div class="checkbox">
   <?php
...
<div class="checkbox ">
 ...
 <div class="col-md-5"> 
   <label>Altura</label> <input type="text" name='altura-mm2' value="<?=$row->altura_mm?>" style='width:30%'> Mm</label> 
   <div class="checkbox">
   <?php
...
<div class="checkbox ">
 ...
 <br/>
<button type='button' class="btn btn-sm btn-primary" id='nuevo-refraccion' >Nuevo</button>
