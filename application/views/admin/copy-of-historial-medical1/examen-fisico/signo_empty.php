...
<div class="col-sm-9">
<div class="input-group">
<input class="form-control talla-in" title="talla en metro" id="talla-ef" type="text" title="Talla en metro">
   <span class="input-group-addon">m</span>
     <input class="form-control pulga-in"  id="pulgada-exf"  type="text" title="Talla en pulgada">
...
$("#talla-ef").keyup(function() {
 $("#pulgada-exf").val($(this).val() * 39.37).number( true, 2);
calculIMC();
});

//------------------------

$("#pulgada-exf").keyup(function() {
$("#talla-ef").val($("#pulgada-exf").val() * 0.0254).number( true, 2);
calculIMC();
});
...
$("#imc").val(imc_result).number( true, 2 );	
}
