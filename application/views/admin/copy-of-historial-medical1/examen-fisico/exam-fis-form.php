...
<tr>
<td class="ida" >
<label class="control-label" >Cuello vv</label>
...
<select  class="form-control select2" id="neuro_s" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis1" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis1"></span>
<textarea class="form-control" rows="11" id="neuro_text"></textarea>
...
<select  class="form-control select2" id="cabeza" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis2" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis2"></span>
<textarea class="form-control" rows="11" id="cabeza_text"></textarea>
...
<select  class="form-control select2" id="cuello" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis3" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis3"></span>
<textarea class="form-control" rows="11" id="cuello_text"></textarea>
</div>
<div class="form-group">
...
<select class="form-control select2 examFisRel" id="ausc" style="width:100%">

</select>
<label>Percusión</label>
<select class="form-control select2 examFisRel" id="perc" style="width:100%">


</select>
<label>Palpación</label>
<select class="form-control select2 examFisRel" id="palpa" style="width:100%">
...
<select  class="form-control select2 examFisExtSup" id="ext_sup" >

</select>
 <br/> <button type="button" id="btnSpeechExamFis4" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis4"></span>
<textarea class="form-control" rows="11" id="ext_sup_text"></textarea>
...
<select class="form-control select2 examFisMama" id="mama_izq1" style="width:100%">
...
<select class="form-control select2 examFisAxil" id="region_ax1"  style="width:100%">
...
<select class="form-control select2 examFisMama" id="mama_izq2"  style="width:100%">
...
<div class="form-group">
<label style="font-weight:bold;font-size:14px">Region Axilar</label>
<select class="form-control select2 examFisAxil" id="region_ax2"  style="width:100%">
...
<select  class="form-control select2 examFisExtSup" id="torax" >

</select>
 <br/> <button type="button" id="btnSpeechExamFis5" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis5"></span>
<textarea class="form-control" rows="11" id="torax_text"></textarea>

</div>
<div class="form-group">
<label class="control-label" >Extremidades Inferiores</label>

<select  class="form-control select2 examFisExtSup" id="ext_inf" >

</select>
 <br/> <button type="button" id="btnSpeechExamFis6" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis6"></span>
<textarea class="form-control" rows="11" id="ext_inft"></textarea>
...
<select  class="form-control select2"  id="cervix" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis7" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis7"></span>
<textarea class="form-control" rows="11" id="cervix_text"></textarea>

</div>
<div class="form-group">
<label class="control-label" >Utero </label>
 <br/> <button type="button" id="btnSpeechExamFis8" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis8"></span>
<textarea class="form-control" rows="11" id="utero_text"></textarea>
...
<div class="form-group">
<label class="control-label" >Inspeccion Vulvar </label>

<select  class="form-control select2"  id="inspection_vulval" >

</select>
 <br/> <button type="button" id="btnSpeechExamFis9" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis9"></span>
<textarea class="form-control" rows="11" id="inspection_vulval_text"></textarea>
...
<select  class="form-control select2" id="rectal" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis10" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis10"></span>
<textarea class="form-control" rows="11" id="rectal_text"></textarea>
</div>
<div class="form-group">
...
<select  class="form-control select2" id="genitalm" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis11" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis11"></span>
<textarea class="form-control" rows="11" id="genitalm_text"></textarea>
</div>
<div class="form-group">
...
<select  class="form-control select2" id="genitalf" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis12" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis12"></span>
<textarea class="form-control" rows="11" id="genitalf_text"></textarea>
</div>
<div class="form-group">
...
<select  class="form-control select2" id="vagina" >
 ...
 <br/> <button type="button" id="btnSpeechExamFis13" title='soporte solo para el navegador Chrome'  class="btn btn-primary btn-sm" ><i class="fa fa-microphone" aria-hidden="true" style="font-size:9px"></i></button>
  &nbsp; <span id="actionSpeechExamFis13"></span>
<textarea class="form-control" rows="11" id="vagina_text"></textarea>
</div>
</div>
</div>
...
<script>
function examFisicNeuro(){
$.ajax({
url:"<?php echo base_url(); ?>admin_medico/examFisicNeuro",
data: {},
method:"POST",
...
$('#neuro_s').html(data);
  ...
  var btnSpeechExamFis1 = document.getElementById('btnSpeechExamFis1');
					
					btnSpeechExamFis1.onclick = function() {
					var output = document.getElementById("neuro_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis1");
					runSpeechRecognition(output,action);
					}
					
					
					 var btnSpeechExamFis2 = document.getElementById('btnSpeechExamFis2');
					
					btnSpeechExamFis2.onclick = function() {
					var output = document.getElementById("cabeza_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis2");
					runSpeechRecognition(output,action);
					}
					
					
					
					  var btnSpeechExamFis3 = document.getElementById('btnSpeechExamFis3');
					
					btnSpeechExamFis3.onclick = function() {
					var output = document.getElementById("cuello_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis3");
					runSpeechRecognition(output,action);
					}
					  ...
					  var btnSpeechExamFis4 = document.getElementById('btnSpeechExamFis4');
					
					btnSpeechExamFis4.onclick = function() {
					var output = document.getElementById("ext_sup_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis4");
					runSpeechRecognition(output,action);
					}
					
					
					
					  var btnSpeechExamFis5 = document.getElementById('btnSpeechExamFis5');
					
					btnSpeechExamFis5.onclick = function() {
					var output = document.getElementById("torax_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis5");
					runSpeechRecognition(output,action);
					}
					
					
					  var btnSpeechExamFis6 = document.getElementById('btnSpeechExamFis6');
					
					btnSpeechExamFis6.onclick = function() {
					var output = document.getElementById("ext_inft");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis6");
					runSpeechRecognition(output,action);
					}
					
					
					  var btnSpeechExamFis7 = document.getElementById('btnSpeechExamFis7');
					
					btnSpeechExamFis7.onclick = function() {
					var output = document.getElementById("cervix_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis7");
					runSpeechRecognition(output,action);
					}
					
					  var btnSpeechExamFis8 = document.getElementById('btnSpeechExamFis8');
					
					btnSpeechExamFis8.onclick = function() {
					var output = document.getElementById("utero_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis8");
					runSpeechRecognition(output,action);
					}
					
					  var btnSpeechExamFis9 = document.getElementById('btnSpeechExamFis9');
					
					btnSpeechExamFis9.onclick = function() {
					var output = document.getElementById("inspection_vulval_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis9");
					runSpeechRecognition(output,action);
					}
					
					
					  var btnSpeechExamFis10 = document.getElementById('btnSpeechExamFis10');
					
					btnSpeechExamFis10.onclick = function() {
					var output = document.getElementById("rectal_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis10");
					runSpeechRecognition(output,action);
					}
					
					
					  var btnSpeechExamFis11 = document.getElementById('btnSpeechExamFis11');
					
					btnSpeechExamFis11.onclick = function() {
					var output = document.getElementById("genitalm_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis11");
					runSpeechRecognition(output,action);
					}
					
					
					  var btnSpeechExamFis12 = document.getElementById('btnSpeechExamFis12');
					
					btnSpeechExamFis12.onclick = function() {
					var output = document.getElementById("genitalf_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis12");
					runSpeechRecognition(output,action);
					}
					
					
					  var btnSpeechExamFis13 = document.getElementById('btnSpeechExamFis13');
					
					btnSpeechExamFis13.onclick = function() {
					var output = document.getElementById("vagina_text");
					// get action element reference
					var action = document.getElementById("actionSpeechExamFis13");
					runSpeechRecognition(output,action);
					}
</script>