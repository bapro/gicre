...
<table  class="table table-striped table-bordered  is_print_rect saved-rows-recetas" style="width:100%" cellspacing="0" id='paginate-rec-<?=$pag_rec?>'>
    ...
    <tr style="background:#428bca;">
	   ...
	   <th style="width:4px;color:white"><strong>Fecha</strong></th>
		...
		<a  class="imprimirRecetasForPat"  target="_blank" href="<?php echo base_url("printings/print_indicaciones/$historial_id/vert/1/singular_id/h_c_indicaciones_medicales")?>"  style="cursor:pointer;color:black" >con la foto</a>
		<a  class="imprimirRecetasForPat"  target="_blank" href="<?php echo base_url("printings/print_indicaciones/$historial_id/vert/0/singular_id/h_c_indicaciones_medicales")?>"  style="cursor:pointer;color:black"  >Sin la foto</a>
		</li>
		<li>
		<a>FORMATO HORIZONTAL</a>
	    <a  class="imprimirRecetasForPat horiz" id='1' target="_blank" href="<?php echo base_url("printings/print_indicaciones/$historial_id/horiz/1/singular_id/h_c_indicaciones_medicales")?>"  style="cursor:pointer;color:black" >con la foto</a>
		<a  class="imprimirRecetasForPat horiz" id='0' target="_blank" href="<?php echo base_url("printings/print_indicaciones/$historial_id/horiz/0/singular_id/h_c_indicaciones_medicales")?>"  style="cursor:pointer;color:black"  >Sin la foto</a>
		</li>
		</ul>
		</li>
		</ul>
