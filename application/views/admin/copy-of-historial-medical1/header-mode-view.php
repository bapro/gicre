...
<?php
 ...
 ?>
  <li><a style="color:red;font-weight:bold" data-toggle="modal" data-target="#ipss2" href="<?php echo base_url("admin_medico/reportHistorialMenu/$user_id/$id_historial/$centro_medico/7")?>" >SCREENING </a> </li>
 <?php } ?>
