...
<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />
 ...
 <!-- owl carousel css -->
<style>
#paginate-exeq td{text-align:left}
#paginate-exeq th{text-align:left}
</style>
</head>
...
<body >
 ...
 <h4>Selecciona un perfil:</h4>
   <div class="radio">
   <label>
      <input type="radio" class="id_radio1" name="perfil" value="Admin"  <?=$disabled_hab?>>  Admin
	   </label>
    </div>
	 <div class="radio">
	 <label>
      <input type="radio" class="id_radio2" name="perfil" value="Medico" checked> Medico
	   </label>
    </div>
	    <div class="radio">
		<label>
	...
	<div class="radio">
	 ...
	 <div class="radio">
	 <label>
      <input type="radio" class="id_radio1" name="perfil" value="Farmacia" <?=$disabled_hab?>>Farmacia
	   </label>
    </div>
	<div class="radio">
	<label>
      <input type="radio" class="id_radio1" name="perfil" value="Farmacia Interna" <?=$disabled_hab?>>Farmacia Interna
	  </label>
    </div>
	 <div class="radio">
	 <label>
      <input type="radio" class="id_radio1" name="perfil" value="Estudios" <?=$disabled_hab?>>Estudios
	   </label>
  </div>
	...
	<!--	<div class="radio">
	<label>
      <input type="radio" class="id_radio1" name="perfil" value="Cliente">Cliente
	  </label>
    </div>-->
...
<div class="col-sm-3">
<input class="form-control" name="area" id="area" style="pointer-events:none" type="text"  >
</div>
</div>
...
<div class="form-group show-centro" style="display:none" >
<label class="control-label col-sm-2" >Seleccionar el Centro Medico</label>
<div class="col-sm-5">
<select class="form-control select2 required"  name="centro"  id="centro">
 <option value="" hidden></option>
 <?php 

	$sqlmd ="SELECT id_m_c, name FROM medical_centers";
 $querymd= $this->db->query($sqlmd);
 foreach ($querymd->result() as $rowmd)
 { 
 echo '<option value="'.$rowmd->id_m_c.'">'.$rowmd->name.'</option>';
 }
 ?>
 </select>
</div>
...
$('.show-centro').show('fast');
} else {
	$('.show-centro').hide('fast');
}
