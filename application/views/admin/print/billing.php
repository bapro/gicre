...
$imgpat='<img  width="130px" src="'.base_url().'/assets/img/patients-pictures/'.$paciente['photo'].'"  />';		
...
$seguron=$this->db->select('title,logo,id_sm')->where('id_sm',$row1->seguro_medico)->get('seguro_medico')->row_array();
...
<br/><br/>
<a style="color:red;font-size:11px" href="https://www.admedicall.com/printings/signaturePatient/<?=$row1->paciente?>/<?=$row2->idfac?>">Crear La Firma Del Pacientes</a>
</td>
</tr>
<?php
}
...
<tr>
<td <?=$style?>>
<strong  style="font-size:11px">Nombre y cedula del afiliado o familiar responsable</strong>
</td>
</tr>
</table>
</td>
