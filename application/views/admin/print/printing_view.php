...
<div class="modal-header">
 <div class="col-xs-12 text-right" >
  ...
  <a  class="btn btn-primary btn-sm" href="<?php echo base_url("admin_medico/medical_insurance_audit_profile_print/$desde/$hasta/$medico")?>"><i class="fa fa-print"></i>  Imprimir</a>
 </div>
<?php
...
<h3 style="text-align:center"><?=$logo['title']?></h3>
 <div style="text-align:center"><img class="img" style="width:100px;" src="<?= base_url();?>/assets/img/seguros_medicos/<?php echo $logo['logo']; ?>" /> </div>
<?php 
