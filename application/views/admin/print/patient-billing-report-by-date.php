...
$imgpat='<img  style="width:80px;" src="'.base_url().'/assets/img/user.png"  />';	
}	
} else if($paciente['photo']==""){
$imgpat='<img  width="80px" src="'.base_url().'/assets/img/user.png"  />';		
}
else{
$imgpat='<img  width="80px" src="'.base_url().'/assets/img/patients-pictures/'.$paciente['photo'].'"  />';		
...
if ($sello_doc) {
$sellodoc='<td><img  style="width:100px;" src="'.base_url().'/assets/update/'.$sello_doc.'"  /></td>';
}else{
$sellodoc='';	
}
