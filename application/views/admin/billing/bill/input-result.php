...
<th>Foto</th><th>NEC</th><th>Nombres</th><th>Cedula</th><th>NO. AFILIADO</th><th>TIPO AFILIADO</th><th>TEL</th><th>DIRECCION</th><th>EMAIL</th><th>CITAS</th>
</tr>
<tr>
<td style="width:17%;">
<?php
...
echo '<img  style="width:130px;"  src="'.base_url().'/assets/img/user.png"  />';	
}
} else if($pat->photo==""){
echo "No hay Foto";	
}
...
<td>   <?=$pat->email?></td>
 <td> <span style='color:green'><?=$count?></span></td>
...
data: {id_p_a:id_p_a,id_user:id_user,perfil:perfil},
cache: true,
