...
?>
    ...
    <div id="two"> <h5 class="h5" style="text-transform:uppercase">paciente : <a target="_blank" href="<?php echo base_url("$controller/patient/$id")?>" ><?=$patient['nombre']?><a></h5></div>
  </div>
</div>
<div class="col-sm-12 tab-content showdown searchb" style="text-align:center" >
<h5 class="h5"  id="cita_number"><?=$cita_number?> <a style="cursor:pointer" id="show2" title="Recargar los resultados">CITA(S)</a></h5> 
<div id="hide2">
