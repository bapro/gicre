...
<?php if(empty($serv_centro)) {
	echo "<span style='color:#B18904'>No hay servicios | <a target='_blank' href='".base_url()."/admin/import_rates_fac_centro/$id_centro/centro'>Crear</a></span>";
...
<a  target="_blank" class="btn btn-primary btn-sm" href="<?php echo base_url("admin_medico/billing_print_view/medico")?>">Ver</a>
</div>
</div>
</div>
</div>
