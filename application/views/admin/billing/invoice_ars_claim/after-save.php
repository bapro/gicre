...
$area=$this->db->select('title_area')->where('id_ar',$row->servicio)
->get('areas')->row('title_area');

if($ars['logo']==""){
$seguro_logo="";
} else{
$seguro_logo='<img  style="width:110px;" src="'.base_url().'/assets/img/seguros_medicos/'.$ars['logo'].'"  />';	
}
...
<p style="text-align:center"><strong>Exeq: <?=$exequatur?> </strong></p>
<h3 style="text-align:center">Relacion de Facturas</h3>
<p style="text-align:center"><strong>RNC: <?=$nncf->value?></strong></p>
    <div class="col-xs-12 text-right" >
<a class="btn btn-primary btn-sm" href="<?php echo base_url("admin/invoice_ars_claim")?>"> ver todo</a> <a class="btn btn-primary btn-sm" href="<?php echo base_url('admin/create_invoice_ars_claim')?>"><i class="fa fa-plus"></i>  Nuevo</a>   <a target="_blank" class="btn btn-primary btn-sm" href="<?php echo base_url('printings/invoice_ars_claim_')?>"><i class="fa fa-print"></i>  Imprimir</a>
  </div>
</div>
...
<td class="paciente"><a target="_blank"  href="<?php echo base_url('admin/Patient/'.$fac->paciente)?>"> <?=$paciente['nombre']?></a></td>
...
?>
<tr><th colspan="5">Total </th><th>RD$ <?php echo $r0f ; ?></th><th>RD$ <?php echo $r1f ; ?></th><th>RD$ <?php echo $r2f ; ?></th></tr>
</table>
</div>
