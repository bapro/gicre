...
<th style="width:1px;color:white">Borrar</th>
	...
	foreach($data2->result() as $row)
	 ...
	 ?>
      ...
      <a data-toggle="modal" data-target="#edit_estudios_or_med2" href="<?php echo base_url("admin_medico/edit_estudios_or_med/$row->id_i_e/$user_id/$direction")?>" style="cursor:pointer" title="Editar" class="btn-sm" ><span class="glyphicon glyphicon-pencil"></span></a>
