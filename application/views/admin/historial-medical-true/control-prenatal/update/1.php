...
<h3 class="modal-title text-center"  >Editar Control Prenal # 1</h3>
</div>
...
<button id="save-cont-pren1" class="btn-sm btn-success" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
</div>
 </div>
