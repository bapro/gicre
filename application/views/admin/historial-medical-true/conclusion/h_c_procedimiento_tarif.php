...
<li>
<a>VERTICAL</a>
<a target='_blank' href="<?php echo base_url("printings/diag_p_vert/$id_cd/0/v")?>"  style="cursor:pointer;color:black" >con foto</a>
<a target='_blank' href="<?php echo base_url("printings/diag_p_vert/$id_cd/1/v")?>"  style="cursor:pointer;color:black"  >Sin foto</a>
</li>
<li>
<a> HORIZONTAL</a>
<a target='_blank' href="<?php echo base_url("printings/diag_p_vert/$id_cd/0/h")?>"  style="cursor:pointer;color:black"  >Con foto</a>
<a target='_blank' href="<?php echo base_url("printings/diag_p_vert/$id_cd/1/h")?>"  style="cursor:pointer;color:black"  >Sin foto</a>
</li>
</ul>
</li>
</ul>
