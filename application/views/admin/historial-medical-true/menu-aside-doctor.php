...
<li><a href="#recetas" class="hide-all-btn-when-incaciones" data-toggle="tab" id='show-recetas-data'>&rArr; Recetas </a></li>
<li><a href="#estudios" class="hide-all-btn-when-incaciones" data-toggle="tab" id='show-estudios-data'>&rArr; Estudios</a></li>
<li><a href="#laboratorios" class="hide-all-btn-when-incaciones" data-toggle="tab" id='show-lab-data' >&rArr; Laboratorios </a></li>
<?php
}
...
elseif(preg_match('/GINECOLOGIA/',$area) && ($row->sexo == 'Feminino' || $row->sexo == 'Feminina' )){
?>
<li><a class="this-is-a-title"><strong>I- ANTECEDENTES</strong></a></li>
<li class="active addb" ><a href="#Datos_personales" class="show-all-btn-when" data-toggle="tab" >&rArr; General</a></li>
