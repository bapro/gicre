...
data:{cups:cups,simons:simons,monto:monto,procedimiento:procedimiento,id_doctor:<?=$id_doctor?>,id_seguro:<?=$id_seguro?>, categoria:<?=$cat->id_categoria?>},
cache: true,
success:function(data){
loadSeguroDocTarif();
}
