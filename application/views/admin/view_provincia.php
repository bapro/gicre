...
<!-- <div class="col-md-2 text-right acionesright">
 ...
 <table class="table table-striped table-bordered" >
	 ...
	 ?>
		<tr>
		<th class="thh">#</th>
		<td class="vtd"><?=$row->id;?></td>
		</tr>
		<tr>
		<th class="thh">Provincia</th>
		<td class="vtd"><?=$row->title;?></td>
...
<li class="active"><a href="#direcciones" data-toggle="tab">Direcciones</a></li>
...
<?php if (empty($PROVINCIA_DIRECION))
{
...
<th class="tablerelaciones"><strong>Calle</strong></th>
...
<?php if (empty($CENTRO_MEDICO_PROVINCIA))
{
...
<?php foreach($CENTRO_MEDICO_PROVINCIA as $c_m_s)
...
<a class="trashcentro" id="<?=$c_m_s->id_m_c; ?>"  style="color:rgb(223,0,0);cursor:pointer"><i class="fa fa-trash-o" aria-hidden="true" ></i></a>
...
<script>
 ...
 //erase centro linked to provinces   
  ...
  $(".trashcentro").click(function(){
   ...
   $.ajax({
            type:'POST',
            url:'<?=base_url('admin/deleteProvinceCentro')?>',
            data: {id : del_id},
            success:function(response) {
