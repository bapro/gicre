...
<button type="button" id="btnPrintCsvs"  class="btn btn-md btn-primary show-kardex-print-csv ms-2" style="display:none;position:fixed"><i class="fa fa-print"></i></button>
</div>
';
...
<thead>
   ...
   <button class="btn btn-default btn-sm dropdown-toggle dropdown-toggle-split" type="button" data-bs-toggle="dropdown" aria-expanded="false">
	...
	<li class="data-li"><a  class=" dropdown-item"  target="_blank" href="#"  >creado por <?=$op;?>, <?=$fecha;?></a></li>
	<li class="data-li"><a  class=" dropdown-item"  target="_blank" href="#"   >cambiado por <?=$upd;?>, <?=$fechaup?></a></li>
		</ul>
