...
<input type="hidden" id="<?= $id_eva_cond ?>_id_eva_cond_update_time" value="<?=$update_time?>" />
                <div class="col-md-6">
                  <label for="<?=$id_eva_cond?>_condicion_general" class="form-label">Condición General <span class="text-danger  fs-5">*</span></label>
                   ...
                   echo "<option value=''></option>";					
					$sqlhev1 ="SELECT DISTINCT condicion_general FROM emerg_eval_cond";
				 ...
				 <div class="col-md-6">
                  <label for="<?=$id_eva_cond?>_eva_diuresis" class="form-label">Diuresis</label>
					...
					<option value=''></option>
					<?php 
					$sqlhev3="SELECT DISTINCT eva_diuresis FROM emerg_eval_cond";
                ...
                <div class="col-md-6">
						...
						<option value=''></option>
						<?php 
						$sqlhev2 ="SELECT DISTINCT estado_conciencia FROM emerg_eval_cond";
					...
					<option value=''></option>
					<?php 
					$sqlhev3="SELECT DISTINCT vomitos_sel FROM emerg_eval_cond";
					$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
					foreach($HEV3->result() as $row3)
					{ 
...
<?php
  ...
  <label class="form-check-label" for="<?=$id_eva_cond?>_orient_pers">Persona</label>
	...
	<option value=''></option>
	<?php 
		$sqlhev3="SELECT DISTINCT drenaje_sonda_nas_sel FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
			...
			?>
				...
				<option value=''></option>
				<?php 
				$sqlhev3="SELECT DISTINCT comunicacion FROM emerg_eval_cond";
				$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
				foreach($HEV3->result() as $row3)
				{ 
			...
			echo '<option value="'.$row3->comunicacion.'" selected>'.$row3->comunicacion.'</option>';
                ...
                <div class="col-md-6">
                  <label for="<?=$id_eva_cond?>_evaluacion_sel" class="form-label">Evaluación</label>
					...
					<option value=''></option>
					<?php 
					$sqlhev3="SELECT DISTINCT evaluacion_sel FROM emerg_eval_cond";
					$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
					foreach($HEV3->result() as $row3)
					{ 
                ...
                <div class="col-md-6">
					...
					<?php 
					$sqlhev3="SELECT DISTINCT val_neuro FROM emerg_eval_cond";
					$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
					foreach($HEV3->result() as $row3)
					{ 
				...
				<option value=''></option>
				<?php 
				$sqlhev3="SELECT DISTINCT diarrea FROM emerg_eval_cond";
				$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
				foreach($HEV3->result() as $row3)
				{ 
			...
			<?php 
			$sqlhev3="SELECT DISTINCT estado_cardia FROM emerg_eval_cond";
			$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
			foreach($HEV3->result() as $row3)
			{ 
			...
			<label for="<?=$id_eva_cond?>_val_abdomen" class="form-label">Val. Abdomen</label>
				...
				<option value=''></option>
				<?php 
				$sqlhev3="SELECT DISTINCT val_abdomen FROM emerg_eval_cond";
				$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
				foreach($HEV3->result() as $row3)
				{ 
			...
			<label for="<?=$id_eva_cond?>_peristalsis" class="form-label">Peristalsis</label>
					...
					<option value=''></option>
					<?php 
					$sqlhev3="SELECT DISTINCT peristalsis FROM emerg_eval_cond";
					$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
					foreach($HEV3->result() as $row3)
					{ 
           ...
           <div class="col-md-6">
				...
				<option value=''></option>
				<?php 
				$sqlhev3="SELECT DISTINCT oxinoterapia FROM emerg_eval_cond";
				$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
				foreach($HEV3->result() as $row3)
				{ 
   ...
   <select   class="form-select selectevaconform"   id="<?=$id_eva_cond?>_alimentacion_sel" data-select2-tags="true"   >
	<option value=''></option>
				<?php 
				$sqlhev3="SELECT DISTINCT alimentacion_sel FROM emerg_eval_cond";
				$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
				foreach($HEV3->result() as $row3)
				{ 
			...
			<option value=''></option>
			<?php 
			$sqlhev3="SELECT DISTINCT terapia_resp FROM emerg_eval_cond";
			$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
			foreach($HEV3->result() as $row3)
			{ 
	...
	<option value=''></option>
<?php 
		$sqlhev3="SELECT DISTINCT sec_vias_resp FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
	...
	<option value=''></option>
	<?php 
		$sqlhev3="SELECT DISTINCT sangrado FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
	...
	<option value=''></option>
		<?php 
		$sqlhev3="SELECT DISTINCT tipo_sangrado FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<option value=''></option>
<?php 
		$sqlhev3="SELECT DISTINCT eva_pulso FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<option value=''></option>
<?php 
		$sqlhev3="SELECT DISTINCT eva_edema FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<option value=''></option>
<?php 
		$sqlhev3="SELECT DISTINCT val_piel FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<select   class="form-select selectevaconform"   id="<?=$id_eva_cond?>_presenta_dolor" data-select2-tags="true"   >
	<option value=''></option>
	<?php 
		$sqlhev3="SELECT DISTINCT presenta_dolor FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<select   class="form-select selectevaconform"   id="<?=$id_eva_cond?>_eva_canalizacion" data-select2-tags="true"  >
	<option value=''></option>
	<?php 
		$sqlhev3="SELECT DISTINCT canalizacion FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<option value=''></option>
<?php 
		$sqlhev3="SELECT DISTINCT cuidados_a FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<select   class="form-select selectevaconform"   id="<?=$id_eva_cond?>_eva_movilizacion" data-select2-tags="true"   >
	<option value=''></option>
	<?php 
		$sqlhev3="SELECT DISTINCT movilizacion FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
...
<select   class="form-select selectevaconform"   id="<?=$id_eva_cond?>_drenaje" data-select2-tags="true"  >
<option value=''></option>
<?php 
		$sqlhev3="SELECT DISTINCT drenajes FROM emerg_eval_cond";
		$HEV3=$this->hospitalization_emgergency->query($sqlhev3);
		foreach($HEV3->result() as $row3)
		{ 
