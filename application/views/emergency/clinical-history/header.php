...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center" >
	  <a  href="<?php echo site_url("emergency/patients_record/$orgine");?>" title="Regresar al listado" ><i class="btn btn-sm btn-outline-primary ms-2 bi bi-arrow-left"></i></a> 
    <div class="d-flex align-items-center justify-content-between">
	
      <a  class="logohop d-flex ms-4" title="<?=$centro_medico_name;?>">
      
        <span>  <img src="<?= base_url();?>assets/img/centros_medicos/<?php echo $centro_logo; ?>" alt="<?=$centro_medico_name;?>"  > </span><span class='text-danger mt-3' style="font-size:20px" > EMERGENCIA</span>
      </a>
