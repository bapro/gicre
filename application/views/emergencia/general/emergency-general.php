...
<?php $this->load->view('emergencia/general/signo-vitales');?>
</div>
...
<?php $this->load->view('emergencia/general/eva-inter');?>
</div>

<div class="tab-pane" id="orden-medica" >
<?php $this->load->view('emergencia/general/orden-medica/index');?>
</div>

<div class="tab-pane" id="procedimiento" >
<?php $this->load->view('emergencia/general/procedimiento/index');?>
</div>
