<div class="col-md-12">
<?php
$sql ="SELECT id_c_taf, sub_groupo FROM centros_tarifarios WHERE groupo LIKE 'Laboratorio' AND centro_id = $centro_id AND seguro_id=$id_seguro GROUP BY sub_groupo ORDER BY sub_groupo ASC";
...
$('.check-lab2').change(function() {
   ...
   if ($(this).is(':checked')) {
	...
	$.ajax({
		...
		cantidad:1,descuento:0,cobert:0.8,id_em:<?=$id_emergency?>,centro:<?=$centro_id?>,printing:2},
