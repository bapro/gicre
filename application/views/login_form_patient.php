...
<html>
  ...
  <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/css/patient-form.css?v=1">
  ...
  <body>
    ...
    <section class="login-content">
	  ...
	  <form class="login-form"  method= "post" action="<?php echo site_url('login/validate_patient');?>">
	  <div class="logo">
     <img  style='width:100%' src="<?= base_url();?>assets/img/logolast.png" alt=""/>
