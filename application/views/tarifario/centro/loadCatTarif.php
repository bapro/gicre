<div id="tttt"></div>
<table class="table table-striped table-sm table-bordered uptade-table"  id="example">
<thead>
<tr>
...
<th> <button type="button" id="NewsaveBtn" class="btn btn-sm btn-success" style="float: none;"><i class="fa fa-save"> </i> Guardar</button></th>
</tr>
...
<a class="st delete-tarifarios-centro" id="<?=$row->id_c_taf; ?>" style="color:red;background:white"  title="Eliminar"><i class="bi bi-trash" aria-hidden="true"></i></a>
...
$.ajax({
type:'POST',
url: "<?=base_url('tarifarios_centro/save_edit_tarifario_centro')?>",
dataType: "json",
...
$.ajax({
type:'POST',
url: "<?=base_url('tarifarios_centro/saveNewTarifCentro')?>",
