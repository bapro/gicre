...
<tr>
<td colspan='3'><input class="form-control rmv-red" id='new-cat-name' placeholder='Nombre de la categoría'/></td>
...
$.ajax({
type: "POST", 
url: '<?php echo site_url('tarifarios_centro/saveNewTarifCentro');?>',
...
$('#servicios').html('<p>status code: '+jqXHR.status+'</p><p>errorThrown: ' + errorThrown + '</p><p>jqXHR.responseText:</p><div>'+jqXHR.responseText + '</div>');
console.log('jqXHR:');
console.log(jqXHR);
...
$.ajax({
type: "POST",
url: '<?php echo site_url('tarifarios_centro/save_edit_c_c');?>',
