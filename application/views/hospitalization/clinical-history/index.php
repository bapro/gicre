<?php $this->load->view('hospitalization/clinical-history/aside');
...
<div class="tab-content" id="v-pills-tabContent">
        ...
        <?php $this->load->view('hospitalization/clinical-history/conc-egreso/index'); ?>

          </div> 
       
		   <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-physic" role="tabpanel" aria-labelledby="v-pills-physic-tab">
        <?php $this->load->view('hospitalization/clinical-history/examen-fisico/index'); ?>
		

          </div>
		  
		   <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-evaCon" role="tabpanel" aria-labelledby="v-pills-evaCon-tab">
        <?php $this->load->view('hospitalization/clinical-history/evaluation-condition/index'); ?>
		

          </div>
		  
<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-system" role="tabpanel" aria-labelledby="v-pills-system-tab">
 <?php $this->load->view('hospitalization/clinical-history/examen-sistema/index'); ?>
</div>

<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-neurolo" role="tabpanel" aria-labelledby="v-pills-neurolo-tab">
 <?php $this->load->view('hospitalization/clinical-history/exam-neuro/index'); ?>
</div>


<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-insumo" role="tabpanel" aria-labelledby="v-pills-insumo-tab">
 <?php $this->load->view('hospitalization/clinical-history/insumo/index'); ?>
</div>
...
<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-cont-sigv" role="tabpanel" aria-labelledby="v-pills-cont-sigv-tab">
 <?php $this->load->view('hospitalization/clinical-history/control-signo-vitales/index'); ?>
</div>



<div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-kardex" role="tabpanel" aria-labelledby="v-pills-kardex-tab">
 <?php $this->load->view('hospitalization/clinical-history/kardex/index'); ?>
</div>
...
<?php 
$this->load->view('hospitalization/clinical-history/notas/index');
  $this->load->view('hospitalization/clinical-history/medical-order/index'); 
 $this->load->view('hospitalization/clinical-history/footer-links'); 
$this->load->view('hospitalization/clinical-history/interconsultas/index'); 
...
$.ajax({
type: "POST",
url: "<?=base_url('hosp_control_signos_vitales/loadContSigVit')?>",
data:{},
