...
if($ex_fis_data==0){
 ...
 foreach($query_ex_fis as $row)
  ...
  $idExf = $row->idSearch;
  $params2 = array('table' => 'hosp_exam_fisico', 'id' => $row->idSearch);
...
<div class="accordion " id="accordionHospExf">
                    <div class="accordion-item ">
                        ...
                        <div id="collapseTwelveHospExf" class="accordion-collapse collapse" aria-labelledby="headingTwelveHospExf" data-bs-parent="#accordionHospExf">
                            <div class="accordion-body">
                                <div class="col-md-12">
                                     <?php $this->load->view('hospitalization/clinical-history/vital-signals/form');?>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="input-group">
      <span class="input-group-text">Hallazgo Positivo <span class="text-danger fs-4">*</span></span>
      <textarea class="form-control required-input-form-exf" id="<?=$idExf?>_hallazgo_exf"  style="height: 200px;"><?= $hallazgo ?></textarea>
    </div>
