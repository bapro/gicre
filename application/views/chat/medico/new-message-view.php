...
<span style='font-size:11px;float:right'><?=$insert_time?><a  id='<?=$mes->idsm?>' title='borrar' class='deletem' style='color:white;cursor:pointer'><i class='fa fa-trash-o'  ></i></a></span>
</p>
</div>
<?php
}
