...
Su cuenta ha sido cambiado en cuenta de pago, favor editar su cuenta para elegir su plan de pago.
<br/>
	...
	<form method="post" id="form_user2" class="form-horizontal" action="<?php echo site_url("paypal/update_account_doctor");?>">
...
<div class="col-sm-4">
<input type="text" class="form-control required"   name="nombre" value='<?=$row->name?>' style="pointer-events:none"  >
</div>
</div>
...
<div class="col-sm-2">
<input class="form-control  required" name="exequatur"  value="<?=$row->exequatur?>"  type="text" style="pointer-events:none"  >
...
<div class="col-sm-2">
<input type="text" class="form-control"   name="cedula" value='<?=$row->cedula?>' style="pointer-events:none"  >
</div>
</div>
...
<div class="col-sm-3">
 <input type="text" class="form-control"   name="cedula" value='<?=$title_area?>' style="pointer-events:none"  >
 </div>
 </div>	
