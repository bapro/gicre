...
<div class="form-group">
<div class="col-sm-3" >
 <button type="submit"  style="float:right" class="btn btn-primary btn-sm enable-send" ><i class="fa fa-floppy-o" aria-hidden="true"></i>  Guardar </button>
</div>
</div>
 </div>
...
<label class="control-label col-sm-3">Centro medico</label>
<div class="col-sm-5 centrom">
<select class="form-control select2 required"  style="width:100%" name="hosp_centro" id="hosp_centro" >
 <option value="" hidden></option>
 <?php 
...
<label class="control-label col-sm-3">Especialidad</label>
<div class="col-sm-4 esp">
<select class="form-control select2 required"  style="width:100%" id="hosp_esp" name="hosp_esp"  onChange="getDocHosp(this.value);" disabled >
...
<label class="control-label col-sm-3">Doctor</label>
<div class="col-sm-6">
<select class="form-control select2 required"  style="width:100%"  name="hosp_doctor" id="hosp_doctor" disabled >
</select>
...
<label class="control-label col-sm-3">Causa</label>
<div class="col-sm-4 cau">
<select class="form-control emergencia required"   name="hosp_causa" id="hosp-causa" >
<option value=""></option>
<?php 
...
<div class="col-sm-4">
<select class="form-control select2 required"  id="hosp_sala" name="hosp_sala"  >
...
<div class="col-sm-4">
<select class="form-control select2 required"   name="hosp_servicio" id="hosp_servicio"  >
...
<div class="col-sm-4">
<select class="form-control select2 required"  name="hosp_cama" id="hosp_cama"  >
...
<div class="col-sm-4">
<input class="form-control emergencia required"  name="hosp_auto" id="hosp_auto"  >
...
<div class="col-sm-4">
<input class="form-control emergencia required"  name="hosp_auto_por" id="hosp_auto_por"  >
...
$(".show-btn-fac-amb").click(function(){
 ...
 $(".show-btn-emergencia").click(function(){
	 $("#orientation").val(2);
 })
 
 
  $(".show-btn-hospitalizacion").click(function(){
	 $("#orientation").val(3);
 })
