...
<table class="table table-striped table-bordered display <?=$paginate?>" >
 <thead>
...
<td style="text-transform: uppercase;"><a href="<?php echo site_url("medico/patient/$ver->id_patient"); ?>"><?=$patient['nombre'];?>  </a> </td>
...
<a target="_blank" href="<?php echo site_url("admin_medico/historial_medical/$ver->id_patient/$id_usr/$area_id"); ?>"><i class="fa fa-history" aria-hidden="true"></i></a>
</td>
</tr>  
