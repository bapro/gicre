...
<input type="hidden"  name="nec" value="RD-<?php echo rand_string(4);?>"  >
...
<input type="text" class="form-control required" data-name="display_age"  onchange="display_age()" id="date_nacer" name="date_nacer" value="01 Enereo 2010">
...
<div class="col-sm-3" >
<input type="text" class="form-control required" id="age" name="age" value="8 anos" readonly >
</div>
</div> 
<div class="form-group">
...
<select class="form-control select2 required"  style="width:100%"  name="provincia" id="provincia"  onchange="selectProvincia(this.options[this.selectedIndex].value)">
<option value="" hidden></option>
<?php
