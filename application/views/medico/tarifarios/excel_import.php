...
<div id="excel_centro" style="display:none">
...
El archivo excel debe tener los siguientes columnas : <br/>codigo, simon,categoria, procedimiento,monto<br/>
...
$.ajax({
	type: "POST",
	url: '<?php echo site_url('medico/check_if_centro_medico_has_tarifarios_already');?>',
	data:{id_c:id_c,updated_by:updated_by},
...
$.ajax({
url:"<?php echo base_url(); ?>medico/import_exel_centro",
method:"POST",
