...
<td class="vtd" >
<input name="email" type="email" id="email" class="form-control" value="<?=$centro_medico->email;?>"/>
<br/>
<button class="btn btn-sm btn-success"  id="edit-email">Editar Email</button>
</td>
...
if(email !=""){
$.ajax({
url:"<?php echo base_url(); ?>medico/editCentroEmail",
data: {email:email,id:<?=$id_medical_center?>},
method:"POST",
