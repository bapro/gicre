...
<a class="btn btn-primary btn-sm" href="<?php echo base_url("admin/invoice_ars_claim")?>"> ver todo</a> 
<a class="btn btn-primary btn-sm" href="<?php echo base_url('admin/create_invoice_ars_claim')?>"><i class="fa fa-plus"></i>  Nuevo</a> 

<a  class="btn btn-primary btn-sm" href="<?php echo base_url("admin_medico/print_ars_fac_found_pat_adm/$patient/$last_id")?>"><i class="fa fa-print"></i>  Imprimir</a>
...
<td class="paciente"><a target="_blank"  href="<?php echo base_url('medico/patient/'.$fac->paciente)?>"> <?=$paciente['nombre']?></a></td>
