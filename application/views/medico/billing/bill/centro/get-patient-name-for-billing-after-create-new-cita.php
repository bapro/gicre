...
<th class="heading">
<?php if(empty($serv_centro)) {
	echo "<span style='color:#B18904'>No hay servicios | <a  href='".base_url()."admin_medico/import_rates_fac_centro/$doc->centro/centro'>Crear</a></span>";
...
<button id="save_factura" <?=$disabled?>  style="margin-left:14px" type="button" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
...
codigoprestado:codigoprestado,fecha:fecha,area:area,exequatur:exequatur,id_apoint:id_apoint,is_admin:is_admin,
