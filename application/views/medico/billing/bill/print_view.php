...
<div class="col-md-4" > 
 <a  class="btn btn-primary btn-sm" href="<?php echo base_url("$controller/bill/$idfacc/privado")?>"><i class="fa fa-pencil"></i>  Editar</a>
  <a  class="btn btn-primary btn-sm" target="_blank" href="<?php echo base_url("printings/print_billing/$idfacc/medico")?>"><i class="fa fa-print"></i>  Imprimir</a>
