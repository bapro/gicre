    ...
    <div class="card-payment">
        ...
        <div id="paymentSection">
            <form method="post" id="paymentForm">
                <h4>Servicio: <b><?php echo $product['name']; ?></b></h4>
                <h4>Cantidad a pagar: <b>$<?php echo $product['price'].' '.$product['currency']; ?></b></h4>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="button" name="card_submit" id="cardSubmitBtn" value="Continuar" class="payment-btn" disabled="true" >
                    </li>
                </ul>
            </form>
        </div>
