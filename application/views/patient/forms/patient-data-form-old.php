            ...
            <div class="card mb-5">
                ...
                <div class="card-body py-1">
                    <div class="row">
                        ...
                        <div class="col-md-3 bg-th rounded-start py-1 ">
                            <div class="text-center pt-1 " id="load-foto" > </div>
				...
				<div style="position:fixed;top:50%;left:50%;z-index:900000" class="show-spin-on-click" id="insertionResult">
				      ...
				      <input name="updated_time"  type="hidden" value="<?=date("Y-m-d H:i:s")?>" />
							 ...
							 <button type="button" style="margin-top:-17px;"  class="btn btn-sm btn-primary not-disabled-button float-end" id="onclick-btn-edit-option"><i class="bi bi-pencil"></i> Editar2</button>
							 <button type="submit" style="display:none; margin-top:-17px;" class="btn btn-sm btn-primary not-disabled-button disabled-btn-duplicate-cedula float-end" id="onclick-btn-save-option"><i class="bi bi-save"></i> Guardar2</button>
...
<input type="" value="0" id="photo-changed" />
