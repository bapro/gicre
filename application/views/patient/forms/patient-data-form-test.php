...
var url= "<?=base_url('utilitaire/updatePatientDataPersonal')?>"; 
...
var fd = new FormData(myform);
var url= "<?=base_url('utilitaire/updatePatientDataOptional')?>"; 
...
$.ajax({
	type: "POST",
	url: "<?php echo site_url('utilitaire/loadPatientPhoto');?>",
