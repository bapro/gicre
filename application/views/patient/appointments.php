 <section class="py-3">
        <div class="container">
            ...
            <div class="card">
			   ...
			   <div class="card-body">
			   <button class="btn btn-primary mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Buscar Citas</button>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-8">
                            <div class="input-group mb-3">
                                ...
                                <input type="date" class="form-control getCurrentDate"  id="desde" name="desde">
                                <span class="input-group-text">Hasta</span>
                                <input type="date" class="form-control getCurrentDate" id="hasta" name="hasta">
...
$('.form-select').select2({
	...
	$('#patient-citas-table').DataTable({
		"aoColumnDefs": [ 
            ...
            "ajax": {
              url: "<?php echo base_url(); ?>patient_cita_controller/citasTable",
              type: 'GET',
              'data': {
				  centro:"<?=$centro?>",
				  desde: "<?=$desde?>",
					...
					$("#load-indications").removeClass("spinner-border");
						$("#load-indications").html(data);
							 ...
							 indication_study_data($("#id_patient_hist").val());
							  ...
							  allLaboratorios($("#id_patient_hist").val(), $('#id_centro_to_save').val());
...
$("#eva_cardiovascular-form").html('<p>status code: '+jqXHR.status+'</p><p>errorThrown: ' + errorThrown + '</p><p>jqXHR.responseText:</p><div>'+jqXHR.responseText + '</div>');
console.log('jqXHR:');
console.log(jqXHR);
