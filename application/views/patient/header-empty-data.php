...
.close{position: relative; z-index: 100}
</style>
<script>
var interval;
...
<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#menu-left-as" aria-expanded="false" aria-controls="navbar">
<span class="sr-only">Toggle navigation</span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
...
$user_id_h = encrypt_url($user_id);$id_hist_enc = encrypt_url($id_historial);
?>
...
<li><a style="color:red;font-weight:bold" href="<?php echo base_url("$controller/orden_medica/$user_id_h/$id_hist_enc")?>" >ORDEN MEDICA <?=$count_ord?></a> </li>
<?php
...
<?php } if($areaid==0 || $areaid==29){
?>
<li><a data-target="#sesion-foto"data-toggle="modal"href="<?php echo base_url("admin_medico/reportHistorialMenu/$user_id/$id_historial/$centro_medico/8") ?>"style="color:red;font-weight:700">SESION DE FOTOS</a></li>
<?php
} 
 if($areaid==0 || $areaid==90){
	 ?><li><a data-target="#screening"data-toggle="modal"href="<?php echo base_url("admin_medico/reportHistorialMenu/$user_id/$id_historial/$centro_medico/7") ?>"style="color:red;font-weight:700">SCREENING</a></li><?php } ?>
...
?>
<a target="_blank" href="<?php echo site_url("$controller/historial_medical/$id_tutor_h/$user_id_h/$areaid_h/$centro_medico_h/$hist_h/$trueuser_h/$from_view"); ?>"><strong><?=$tut->relacion?></strong> : <?=$tut->name_tutor?></a>
</li>
<?php
}
?>
...
<li><?=$go_back_cita?></li>
<li><a> <?=$nocreatecita?></a></li>
</ul>


<ul class="nav navbar-nav navbar-right"  style="margin-right:3%">
<li id='working-doc'></li>
<li <?=$saveHistBtn?>><a> <button   class="btn btn-md btn-success save_ant_gen" id="save_ant_gen"  type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar </button></a></li>
...
<div class="fade modal"id="sesion-foto"role="dialog">
<div class="modal-dialog modal-lg" style="width: 95%;">
<div class="modal-content"></div>
</div>
</div>
<div class="fade modal"id="screening"role="dialog"><div class="modal-dialog modal-lg"><div class="modal-content"></div></div></div>
<script>

$('#screening').on('hidden.bs.modal', function () {
...
,$("#quirurgia").on("hidden.bs.modal",function(){$(this).removeData("bs.modal")})
</script>
