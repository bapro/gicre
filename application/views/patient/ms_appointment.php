 <section class="py-3">
        <div class="container">
            ...
            <div class="card">
			   ...
			   <div class="card-body">
			   <button class="btn btn-primary mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Filtrar Citas Por Centro Y Rango de Fecha</button>
			     <div class="collapse" id="collapseExample">
                    <h6>Seleccione un centro medico</h6>
					<form method="GET" action="<?php echo site_url("$controller/ms_appointments_by_date_range");?>" >
                    <div class="row g-2">
                        ...
                        <div class="col-md-8">
                            <div class="input-group mb-3">
                                ...
                                <input type="date" class="form-control getCurrentDate" placeholder="" id="desde" name="desde">
                                <span class="input-group-text">Hasta</span>
                                <input type="date" class="form-control getCurrentDate" placeholder="" id="hasta" name="hasta">
				   	...
				   	<div class="col-md-12" style="display:none">
                         ...
                         <select class="form-select centro_medico_doct" id="centro_medico_doct" multiple="multiple" name="centro_medico_doct[]" >
						 	<?php 
							$centro_medicos = $this->model_admin->view_as_doctor_centro($this->session->userdata('user_id'));
								
                                  foreach ($centro_medicos as $rowcent)
									{
...
<?php $this->load->view('patient/modals-citas'); ?>
	...
	<input id="centro"  type="hidden"  value="<?=$centro?>" />
...
var centro=$("#centro").val();
    ...
    // Set the default value of the date input element to today's date
    $('.getCurrentDate').val(getTodayDate());
...
$('.form-select').select2({
	...
	$('#patient-citas-table').DataTable({
		"aoColumnDefs": [ 
            ...
            "ajax": {
              url: "<?php echo base_url(); ?>utilitaire/citasTableAsistenteMedico",
              type: 'GET',
              'data': {
				  centro:"<?=$centro?>",
				  desde: "<?=$desde?>",
				  hasta: "<?=$hasta?>",
				  centro_as:$('#centro_medico_doct').val()
			  }
            },
