...
$name=$this->session->userdata['laboratorios_name'];
$perfil=$this->session->userdata['laboratorios_perfil'];
...
<li><a href="<?php echo site_url('estudios/despachadas');?>"> Laboratorios Despachadas</a></li>
</li>
...
<li><a href="<?php echo site_url('login/laboratorios_logout');?>" ><i class="fa fa-sign-out"></i>  Cerrar Session</a></li>
