...
class Consult_tarifario_por_web_service_controller extends CI_Controller {
...
$precio=$this->db->select('monto')->where('id_tarif',$id)->get('tarifarios_temporal')->row('monto');
//echo $precio;
if($nap_state==1){
