<?php
class Hosp_orden_medica_lab extends CI_Controller {
...
function save_indication_lab()
    {
      ...
      $save = array(
        ...
        $this->hospitalization_emgergency->insert('hosp_orden_medcia_lab',$save);
...
$sql ="SELECT * FROM hosp_orden_medcia_lab WHERE id_register=$ordenMedInsertedId  AND historial_id=$this->ID_PATIENT AND canceled=0 ORDER BY id DESC";
...
$this->load->view('hospitalization/clinical-history/medical-order/lab/table', $data);
