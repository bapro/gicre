...
class Hosp_exam_fisico extends CI_Controller {
 ...
 function saveExamenFisico()
        {
             ...
             $rowSigNota= array(
                ...
                if ($this->input->post('idExF') == 0) {
                 //INSERT NOTA
                   $this->hospitalization_emgergency->insert('hosp_exam_fisico', $rowSigNota);
                   ...
                   //INSERT SIGNO VITALES
                    ...
                    $this->hospitalization_emgergency->update('hosp_exam_fisico', $rowSigNota);
...
$sql="SELECT *, hosp_exam_fisico.id AS idSearch FROM hosp_exam_fisico INNER JOIN  hosp_signo_vitales ON hosp_exam_fisico.id = hosp_signo_vitales.id_exam_fisico WHERE hosp_exam_fisico.id=$page";
...
$this->load->view('hospitalization/clinical-history/examen-fisico/form', $data);
...
public function pagination() {
    $sql="SELECT * FROM hosp_exam_fisico WHERE id_patient=$this->ID_PATIENT AND centro=$this->ID_CENTRO ORDER BY id DESC";
