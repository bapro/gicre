...
$.ajax({
type: "POST",
url:base_url+"emerg_kardex/savePrintKardex",
data:{id_print:id_print},
 success:function(data){ 
window.open(base_url +'print_page_emergency/printKardex', '_blank', 'noopener, noreferrer');
...
setInterval(function(){
	$("#kardex-undone").load(base_url+"emerg_kardex/kardex_undone_notification");
},5000);
...
$.ajax({
type:'POST',
url:base_url+"emerg_kardex/listadoMedKardex",
data: {},
success:function(data) {
...
$.ajax({
url:base_url+"emerg_kardex/addNewKardex",
...
$.ajax({
type:'POST',
url:base_url+"emerg_kardex/kardex_list",
data: {},
success:function(data) {
...
$.ajax({
url:base_url+"emerg_kardex/devolucionMedicamentos",
...
//------------------------------------------------------------------------------------
$.ajax({
url:base_url+"emerg_kardex/devolucionAlmacenMed",
