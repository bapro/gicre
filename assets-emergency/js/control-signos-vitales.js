...
$.ajax({
type:'POST',
url:base_url+"emerg_control_signos_vitales/deleteControSigVital",
data: {id : del_id},
...
$(document).on('click','#btnPrintCsvs',function(event){
...
$.ajax({
type: "POST",
url:base_url+"emerg_control_signos_vitales/savePrintCsv",
data:{id_print:id_print},
 success:function(data){ 
window.open(base_url +'print_page_emergency/contro_signos_vitales', '_blank', 'noopener, noreferrer');
